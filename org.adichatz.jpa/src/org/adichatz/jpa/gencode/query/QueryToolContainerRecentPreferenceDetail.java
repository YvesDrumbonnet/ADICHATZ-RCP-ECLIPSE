	...
	public void createContents(){
		...
		preferenceDetailGRP = new GroupController("preferenceDetail", coreController, this) {
			...
			public void createControl() {
				...
				if (isValid()) {
					...
					getControl().setFont(EngineTools.getModifiedFont(getControl().getFont(), SWT.BOLD));
				}
			}
		};
		...
		preferenceFilterGroupPGRP = new PGroupController("preferenceFilterGroup", preferencePaginationCmpCMPS, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setImage(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImage("IMG_FILTER"));
