/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Jul 07 18:46:52 CEST 2020
 *
 * 				+----------------------------------------+
		...
		if (null != context) {
			coreController = new CompositeController("paginationCmp", parentController, this) {
				...
				public void synchronize() {
					super.synchronize();
					if (isValid()) {
						AEntityListener paginationCmpLSTN$0 = new AEntityListener("AFTER_PROPERTY_CHANGE", coreController, IEventType.AFTER_PROPERTY_CHANGE) {
							@Override
