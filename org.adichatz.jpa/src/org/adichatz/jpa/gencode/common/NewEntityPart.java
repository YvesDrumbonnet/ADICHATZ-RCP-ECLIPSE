	...
	public void createContents(){
		...
		detailCMPCMPS = new CompositeController("detailCMP", coreController, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					ABindingListener detailCMPLSTN$0 = new ABindingListener("postMessage", IEventType.POST_MESSAGE) {
						@Override
		...
		if (!EngineTools.isEmpty(detailINCIK)) {
			...
			detailINCINCL = new IncludeController("detailINC", detailCMPCMPS, new EntityManagerCore(getContext())) {
				@Override
				public void createContents() {
					// loads and instantiates the class for 'detailINCINCL' include wrapper.
