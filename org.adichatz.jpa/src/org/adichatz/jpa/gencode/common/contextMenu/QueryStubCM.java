/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat May 04 17:31:36 CEST 2019
 *
 * 				+----------------------------------------+
...
@AdiResourceURI(URI="adi://org.adichatz.jpa/common.contextMenu/QueryStubCM")
public class QueryStubCM extends ATabularContextMenuCore {
	...
	// the ActionController addRelationshipActionACT.
	private ActionController addRelationshipActionACT;
	// the ActionController deleteRelationshipActionACT.
	private ActionController deleteRelationshipActionACT;
	/**
	 * Instantiates a new QueryStubCM.
	 * 
	 ...
	 */
	public QueryStubCM(AdiContext parentContext, IContainerController parentController) {
		coreController = parentController;
	}

	/**
	 * Creates the include QueryStubCM.
	 *
	 * @param context
	 ...
	 *            The parent context
	 */
	public QueryStubCM(ParamMap paramMap, IContainerController parentController, String id, AdiContext parentContext) {
		...
		headerMenuManagerWrapper$$1HMM = new MenuManagerController("headerMenuManagerWrapper$$1", coreController, this) {
			...
			public void startLifeCycle() {
				super.startLifeCycle();
					...
					hideColumnActionACT = new HideColumnActionController("hideColumnAction", headerMenuManagerWrapper$$1HMM, QueryStubCM.this);
					// Creates control for ShowColumnMenuManagerController showColumnsMM
					showColumnsMM = new ShowColumnMenuManagerController("showColumns", headerMenuManagerWrapper$$1HMM, QueryStubCM.this);
					// Creates control for RefreshColumnSizeActionController refreshColumnSizeACT
					refreshColumnSizeACT = new RefreshColumnSizeActionController("refreshColumnSize", headerMenuManagerWrapper$$1HMM, QueryStubCM.this);
					// Creates control for SeparatorController separatorWrapper$$2SPR
					separatorWrapper$$2SPR = new SeparatorController("separatorWrapper$$2", headerMenuManagerWrapper$$1HMM, QueryStubCM.this);
					// Creates control for AddColumnFilterActionController addColumnFilterActionACT
					addColumnFilterActionACT = new AddColumnFilterActionController("addColumnFilterAction", headerMenuManagerWrapper$$1HMM, QueryStubCM.this) {
						@Override
					...
					removeColumnFilterActionACT = new RemoveColumnFilterActionController("RemoveColumnFilterAction", headerMenuManagerWrapper$$1HMM, QueryStubCM.this) {
						@Override
						public void initialize() {
							BooleanSupplier evaluatorVALID;
							evaluatorVALID = new BooleanSupplier() {
		...
		contextMenuMM = new MenuManagerController("contextMenu", coreController, this) {
			...
			public void startLifeCycle() {
				super.startLifeCycle();
					...
					refreshTableActionACT = new ActionController("refreshTableAction", contextMenuMM, QueryStubCM.this) {
						@Override
						public void initialize() {
					...
					separatorWrapper$$3SPR = new SeparatorController("separatorWrapper$$3", contextMenuMM, QueryStubCM.this);
					// Creates control for FilterByValueActionController filterByValueActionACT
					filterByValueActionACT = new FilterByValueActionController("filterByValueAction", contextMenuMM, QueryStubCM.this) {
						@Override
						public void initialize() {
							BooleanSupplier evaluatorVALID;
							evaluatorVALID = new BooleanSupplier() {
					...
					disableAllFiltersActionACT = new DisableAllFiltersActionController("disableAllFiltersAction", contextMenuMM, QueryStubCM.this) {
						@Override
						public void initialize() {
							BooleanSupplier evaluatorVALID;
							evaluatorVALID = new BooleanSupplier() {
					...
					enableAllFiltersActionACT = new EnableAllFiltersActionController("enableAllFiltersAction", contextMenuMM, QueryStubCM.this) {
						@Override
						public void initialize() {
							BooleanSupplier evaluatorVALID;
							evaluatorVALID = new BooleanSupplier() {
					...
					removeAllFiltersActionACT = new RemoveAllFiltersActionController("removeAllFiltersAction", contextMenuMM, QueryStubCM.this) {
						@Override
						public void initialize() {
							BooleanSupplier evaluatorVALID;
							evaluatorVALID = new BooleanSupplier() {
					...
					separatorWrapper$$4SPR = new SeparatorController("separatorWrapper$$4", contextMenuMM, QueryStubCM.this);
					// Creates control for ActionController copyTableToClipboardActionACT
					copyTableToClipboardActionACT = new ActionController("copyTableToClipboardAction", contextMenuMM, QueryStubCM.this) {
						@Override
						public void initialize() {
							getParamMap().put("TABULAR_CONTROLLER", ((MenuManagerController) getFromRegister("contextMenu")).getMenuContainer());
							super.initialize();
					...
					separatorWrapper$$5SPR = new SeparatorController("separatorWrapper$$5", contextMenuMM, QueryStubCM.this);
					// Creates control for ActionController addRelationshipActionACT
					addRelationshipActionACT = new ActionController("addRelationshipAction", contextMenuMM, QueryStubCM.this) {
						@Override
						public void initialize() {
							getParamMap().put("TABULAR_CONTROLLER", ((MenuManagerController) getFromRegister("contextMenu")).getMenuContainer());
							super.initialize();
						...
						public void createControl() {
							if (isValid()) {
								action = new AddRelationshipAction();
								action.setActionController(this);
							}
							super.createControl();
						}
					};
					// Creates control for ActionController deleteRelationshipActionACT
					deleteRelationshipActionACT = new ActionController("deleteRelationshipAction", contextMenuMM, QueryStubCM.this) {
						@Override
						public void initialize() {
							getParamMap().put("TABULAR_CONTROLLER", ((MenuManagerController) getFromRegister("contextMenu")).getMenuContainer());
							BooleanSupplier evaluatorVALID;
