			...
			public void startLifeCycle() {
				super.startLifeCycle();
					...
					crossReferenceMM = new MenuManagerController("crossReference", contextMenuMM, QueryFormCM.this) {
						...
						public void createControl() {
							if (isValid()) {
								setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_CROSS_REFERENCE"));
					...
					preferenceMenuMM = new MenuManagerController("preferenceMenu", contextMenuMM, QueryFormCM.this) {
						...
						public void createControl() {
							if (isValid()) {
								setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_PREFERENCE"));
