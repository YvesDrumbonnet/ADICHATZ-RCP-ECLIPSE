...
@AdiResourceURI(URI="adi://org.adichatz.jpa/common.contextMenu/RelationshipCM")
public class RelationshipCM extends ATabularContextMenuCore {
	...
	/**
	 * Instantiates a new RelationshipCM.
	 * 
	 ...
	 */
	public RelationshipCM(AdiContext parentContext, IContainerController parentController) {
		coreController = parentController;
	}

	/**
	 * Creates the include RelationshipCM.
	 *
	 * @param context
	 ...
	 *            The parent context
	 */
	public RelationshipCM(ParamMap paramMap, IContainerController parentController, String id, AdiContext parentContext) {
		...
		headerMenuManagerWrapper$$1HMM = new MenuManagerController("headerMenuManagerWrapper$$1", coreController, this) {
			...
			public void startLifeCycle() {
				super.startLifeCycle();
					...
					hideColumnActionACT = new HideColumnActionController("hideColumnAction", headerMenuManagerWrapper$$1HMM, RelationshipCM.this);
					// Creates control for ShowColumnMenuManagerController showColumnsMM
					showColumnsMM = new ShowColumnMenuManagerController("showColumns", headerMenuManagerWrapper$$1HMM, RelationshipCM.this);
					// Creates control for RefreshColumnSizeActionController refreshColumnSizeACT
					refreshColumnSizeACT = new RefreshColumnSizeActionController("refreshColumnSize", headerMenuManagerWrapper$$1HMM, RelationshipCM.this);
					// Creates control for SeparatorController separatorWrapper$$2SPR
					separatorWrapper$$2SPR = new SeparatorController("separatorWrapper$$2", headerMenuManagerWrapper$$1HMM, RelationshipCM.this);
					// Creates control for AddColumnFilterActionController addColumnFilterActionACT
					addColumnFilterActionACT = new AddColumnFilterActionController("addColumnFilterAction", headerMenuManagerWrapper$$1HMM, RelationshipCM.this) {
						@Override
					...
					removeColumnFilterActionACT = new RemoveColumnFilterActionController("RemoveColumnFilterAction", headerMenuManagerWrapper$$1HMM, RelationshipCM.this) {
						@Override
						public void initialize() {
							super.initialize();
							BooleanSupplier evaluatorVALID;
		...
		contextMenuMM = new MenuManagerController("contextMenu", coreController, this) {
			...
			public void startLifeCycle() {
				super.startLifeCycle();
					...
					refreshTableActionACT = new ActionController("refreshTableAction", contextMenuMM, RelationshipCM.this) {
						@Override
						public void initialize() {
					...
					separatorWrapper$$3SPR = new SeparatorController("separatorWrapper$$3", contextMenuMM, RelationshipCM.this);
					// Creates control for FilterByValueActionController filterByValueActionACT
					filterByValueActionACT = new FilterByValueActionController("filterByValueAction", contextMenuMM, RelationshipCM.this) {
						@Override
						public void initialize() {
							super.initialize();
							BooleanSupplier evaluatorVALID;
					...
					disableAllFiltersActionACT = new DisableAllFiltersActionController("disableAllFiltersAction", contextMenuMM, RelationshipCM.this) {
						@Override
						public void initialize() {
							super.initialize();
							BooleanSupplier evaluatorVALID;
					...
					enableAllFiltersActionACT = new EnableAllFiltersActionController("enableAllFiltersAction", contextMenuMM, RelationshipCM.this) {
						@Override
						public void initialize() {
							super.initialize();
							BooleanSupplier evaluatorVALID;
					...
					removeAllFiltersActionACT = new RemoveAllFiltersActionController("removeAllFiltersAction", contextMenuMM, RelationshipCM.this) {
						@Override
						public void initialize() {
							super.initialize();
							BooleanSupplier evaluatorVALID;
					...
					separatorWrapper$$4SPR = new SeparatorController("separatorWrapper$$4", contextMenuMM, RelationshipCM.this);
					// Creates control for ActionController copyTableToClipboardActionACT
					copyTableToClipboardActionACT = new ActionController("copyTableToClipboardAction", contextMenuMM, RelationshipCM.this) {
						@Override
						public void initialize() {
							getParamMap().put("TABULAR_CONTROLLER", ((MenuManagerController) getFromRegister("contextMenu")).getMenuContainer());
							super.initialize();
					...
					separatorWrapper$$5SPR = new SeparatorController("separatorWrapper$$5", contextMenuMM, RelationshipCM.this);
					// Creates control for ActionController addRelationshipActionACT
					addRelationshipActionACT = new ActionController("addRelationshipAction", contextMenuMM, RelationshipCM.this) {
						@Override
						public void initialize() {
							getParamMap().put("TABULAR_CONTROLLER", ((MenuManagerController) getFromRegister("contextMenu")).getMenuContainer());
							super.initialize();
					...
					deleteRelationshipActionACT = new ActionController("deleteRelationshipAction", contextMenuMM, RelationshipCM.this) {
						@Override
						public void initialize() {
							getParamMap().put("TABULAR_CONTROLLER", ((MenuManagerController) getFromRegister("contextMenu")).getMenuContainer());
							super.initialize();
