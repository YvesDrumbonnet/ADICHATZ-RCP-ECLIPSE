...
public class MasterDetailTBM extends MasterDetailStubTBM {
	...
	public void createContents(){
			...
			public void createControl() {
				if (isValid()) {
					action =  new AAction() {
						...
						public void init() {
							super.init();
							setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_VERTICAL_EXPAND_HEADER"));
				...
				super.createControl();
				if (isValid()) {
					getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_VERTICAL_EXPAND_HEADER"));
			...
			public void createControl() {
				if (isValid()) {
					action =  new AAction() {
						...
						public void init() {
							super.init();
							setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_HORIZONTAL"));
				...
				super.createControl();
				if (isValid()) {
					getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_HORIZONTAL"));
		...
		AControlListener managedToolBarLSTN$0 = new AControlListener(null, IEventType.AFTER_END_LIFE_CYCLE) {
			@Override
	...
	protected void expand(AAction action, Control control) {
	    ...
	    if (!control.equals(sashForm.getMaximizedControl())) {
	        ...
	        if(SWT.HORIZONTAL == sashForm.getOrientation())
	           action.setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_HORIZONTAL"));     			
	        else
	...
	protected void setImages() {
	   if(SWT.HORIZONTAL == getSashForm().getOrientation()) {
			((ActionController) getFromRegister("changeOrientationAction")).getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_VERTICAL"));
			...
			((ActionController) getFromRegister("expandHeaderAction")).getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_HORIZONTAL_EXPAND_HEADER"));
			((ActionController) getFromRegister("expandDetailAction")).getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_HORIZONTAL_EXPAND_DETAIL"));
	   } else {
			((ActionController) getFromRegister("changeOrientationAction")).getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_HORIZONTAL"));
			...
			((ActionController) getFromRegister("expandHeaderAction")).getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_VERTICAL_EXPAND_HEADER"));
