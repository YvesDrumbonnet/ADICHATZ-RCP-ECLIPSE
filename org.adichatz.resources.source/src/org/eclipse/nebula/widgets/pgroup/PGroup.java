 ...
 * <p>
 * This widget is customizable through alternative <code>AbstractGroupStrategy</code>s. Each strategy determines the size and
...
public class PGroup extends Canvas {
	 ...
	 * {@link Composite#setBackgroundMode(int)} with {@link SWT#INHERIT_DEFAULT} or {@link SWT#INHERIT_DEFAULT}
	 * </p>
	 * 
	 * @param parent
	...
	public PGroup(Composite parent, int style) {
		...
		initialFont = new Font(getDisplay(), getFont().getFontData()[0].getName(), getFont().getFontData()[0].getHeight(),
				SWT.BOLD);
	...
	/**
	 * Sets the receiver's background color to the color specified by the argument, or to the default system color for the control
	 * if the argument is null.
	 * <p>
	 * Note: This operation is a hint and may be overridden by the platform. For example, on Windows the background of a Button
	 * cannot be changed.
	 * </p>
	 * <p>
	 * To ensure that the color of corners is equal to one of the underlying control invoke the parent composites
	...
	/**
	 * Sets the toggle renderer. If the toggle renderer is set to <code>null</code> the control will not show a toggle or allow the
	 * user to expand/collapse the group by clicking on the title.
	 *
	 * @param toggleRenderer
	 *            the toggleRenderer to set or <code>null</code>
	 *
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
	...
	private void onMouseMove(Event e) {
		...
		if (toolitems.size() > 0) {
			...
			while (it.hasNext()) {
				...
				// PGroupItem.bounds could be null (!?).
				if (null != item.getBounds())
	...
	/**
	 * Adds the listener to the collection of listeners who will be notified when the receiver is expanded or collapsed by sending
	 * it one of the messages defined in the <code>ExpandListener</code> interface.
	 *
	 * @param listener
	...
	/**
	 * Returns the image position. The image position is a combination of integer constants OR'ed together.
	 *
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
	...
	/**
	 * Sets the image position. The image position is a combination of integer constants OR'ed together. Valid values are
	 * <code>SWT.LEFT</code> and <code>SWT.RIGHT</code> (mutually exclusive). <code>SWT.TOP</code> is hint interpreted by some
	 * strategies.
	 *
	 * @exception IllegalArgumentException
	 *                <ul>
	...
	/**
	 * Returns the toggle position. The toggle position is a combination of integer constants OR'ed together.
	 *
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
	...
	/**
	 * Sets the toggle position. The toggle position is a combination of integer constants OR'ed together. Valid values are
	 * <code>SWT.LEFT</code> and <code>SWT.RIGHT</code> (mutually exclusive).
	 *
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
	...
	/**
	 * Returns the line position. The line position is a combination of integer constants OR'ed together.
	 *
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
	...
	/**
	 * Sets the line position. The line position is a combination of integer constants OR'ed together. Valid values are
	 * <code>SWT.BOTTOM</code> and <code>SWT.CENTER</code> (mutually exclusive).
	 *
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
	...
	/**
	 * Sets the receiver's foreground color to the color specified by the argument, or to the default system color for the control
	 * if the argument is null.
	 * <p>
	 * Note: This operation is a hint and may be overridden by the platform.
	 * </p>
	 * <p>
	 * Note: If a new strategy is set on the receiver it may overwrite the existing foreground color.
	 * </p>
	 * 
	 * @param color
	 *            the new color (or null)
