...
public class ClassImpl implements IClass {
	...
	public ClassImpl(ITestContext context, Class cls, XmlClass xmlClass, Object instance, Map<Class, IClass> classes,
	...
	private Object getDefaultInstance() {
		if (m_defaultInstance == null) {
			if (m_instance != null) {
				...
				m_defaultInstance = ClassHelper.createInstance(m_class, m_classes, m_xmlTest, m_annotationFinder, m_objectFactory);
			}
		}
