/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:34:27 CEST 2020
 *
 * 				+----------------------------------------+
...
public class GridColumnPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates GridColumnPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public GridColumnPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		cellSelectionEnabled$1LBL = new LabelController("cellSelectionEnabled$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		headerFont$1LBL = new LabelController("headerFont$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		headerWordWrap$1LBL = new LabelController("headerWordWrap$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		minimumWidth$1LBL = new LabelController("minimumWidth$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		summary$1LBL = new LabelController("summary$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		wordWrap$1LBL = new LabelController("wordWrap$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public XjcTextController createCellSelectionEnabled(ControllerCore genCode) {
		...
		cellSelectionEnabledTXT = new XjcTextController("cellSelectionEnabled", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public FontController createHeaderFont(ControllerCore genCode) {
		...
		headerFontTXT = new FontController("headerFont", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createHeaderWordWrap(ControllerCore genCode) {
		...
		headerWordWrapTXT = new TextController("headerWordWrap", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public NumericTextController createMinimumWidth(ControllerCore genCode) {
		...
		minimumWidthNTXT = new NumericTextController("minimumWidth", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public XjcTextController createSummary(ControllerCore genCode) {
		...
		summaryTXT = new XjcTextController("summary", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createWordWrap(ControllerCore genCode) {
		...
		wordWrapTXT = new TextController("wordWrap", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
