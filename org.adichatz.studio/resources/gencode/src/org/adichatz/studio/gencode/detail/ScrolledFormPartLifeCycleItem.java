...
public class ScrolledFormPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates ScrolledFormPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public ScrolledFormPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createBindingServiceClassNameScrolledFormPART$1(ControllerCore genCode) {
		...
		bindingServiceClassNameScrolledFormPART$1HL = new OutlineHyperlinkController("bindingServiceClassNameScrolledFormPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createControllerClassNameScrolledFormPART$1(ControllerCore genCode) {
		...
		controllerClassNameScrolledFormPART$1HL = new OutlineHyperlinkController("controllerClassNameScrolledFormPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIScrolledFormPART$1(ControllerCore genCode) {
		...
		entityURIScrolledFormPART$1HL = new OutlineHyperlinkController("entityURIScrolledFormPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
