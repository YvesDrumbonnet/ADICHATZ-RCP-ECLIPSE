...
public class ScrolledFormPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createBindingServiceClassNameScrolledFormPART$1(ControllerCore genCode) {
		...
		bindingServiceClassNameScrolledFormPART$1HL = new HyperlinkController("bindingServiceClassNameScrolledFormPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameScrolledFormPART$1(ControllerCore genCode) {
		...
		controllerClassNameScrolledFormPART$1HL = new HyperlinkController("controllerClassNameScrolledFormPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIScrolledFormPART$1(ControllerCore genCode) {
		...
		entityURIScrolledFormPART$1HL = new HyperlinkController("entityURIScrolledFormPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
