...
public class IncludePart extends AContainerCore {
	...
	// the HyperlinkController adiResourceURIIncludePART$1HL.
	private HyperlinkController adiResourceURIIncludePART$1HL;
	// the AdiResourceUriTextController adiResourceURITXT.
	private AdiResourceUriTextController adiResourceURITXT;
	// the HyperlinkController controllerClassNameIncludePART$1HL.
	private HyperlinkController controllerClassNameIncludePART$1HL;
	...
	*/
	...
	public HyperlinkController createAdiResourceURIIncludePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController adiResourceURIIncludePART$1HL
		adiResourceURIIncludePART$1HL = new HyperlinkController("adiResourceURIIncludePART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameIncludePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameIncludePART$1HL
		controllerClassNameIncludePART$1HL = new HyperlinkController("controllerClassNameIncludePART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
