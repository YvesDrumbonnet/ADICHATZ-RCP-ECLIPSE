...
public class PGroupToolItemPart extends AContainerCore {
	...
	// the OutlineHyperlinkController actionClassNamePGroupToolItemPART$1HL.
	private OutlineHyperlinkController actionClassNamePGroupToolItemPART$1HL;
	// the ClassTextController actionClassNameTXT.
	private ClassTextController actionClassNameTXT;
	// the OutlineHyperlinkController controllerClassNamePGroupToolItemPART$1HL.
	private OutlineHyperlinkController controllerClassNamePGroupToolItemPART$1HL;
	...
	*/
	...
	public OutlineHyperlinkController createActionClassNamePGroupToolItemPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController actionClassNamePGroupToolItemPART$1HL
		actionClassNamePGroupToolItemPART$1HL = new OutlineHyperlinkController("actionClassNamePGroupToolItemPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createControllerClassNamePGroupToolItemPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNamePGroupToolItemPART$1HL
		controllerClassNamePGroupToolItemPART$1HL = new OutlineHyperlinkController("controllerClassNamePGroupToolItemPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
