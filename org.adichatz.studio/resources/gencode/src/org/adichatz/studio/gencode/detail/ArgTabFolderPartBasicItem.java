/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:41 CET 2019
 *
 * 				+----------------------------------------+
...
public class ArgTabFolderPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameArgTabFolderPART$1HL.
	private HyperlinkController controllerClassNameArgTabFolderPART$1HL;
	...
	// the HyperlinkController entityURIArgTabFolderPART$1HL.
	private HyperlinkController entityURIArgTabFolderPART$1HL;
	...
	// the HyperlinkController labelProviderClassNameArgTabFolderPART$1HL.
	private HyperlinkController labelProviderClassNameArgTabFolderPART$1HL;
	...
	public HyperlinkController createControllerClassNameArgTabFolderPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameArgTabFolderPART$1HL
		controllerClassNameArgTabFolderPART$1HL = new HyperlinkController("controllerClassNameArgTabFolderPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIArgTabFolderPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIArgTabFolderPART$1HL
		entityURIArgTabFolderPART$1HL = new HyperlinkController("entityURIArgTabFolderPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameArgTabFolderPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController labelProviderClassNameArgTabFolderPART$1HL
		labelProviderClassNameArgTabFolderPART$1HL = new HyperlinkController("labelProviderClassNameArgTabFolderPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
