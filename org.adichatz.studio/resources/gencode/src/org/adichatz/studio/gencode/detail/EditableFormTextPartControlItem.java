/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:52:32 CEST 2020
 *
 * 				+----------------------------------------+
...
public class EditableFormTextPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates EditableFormTextPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public EditableFormTextPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		labelBackground$1LBL = new LabelController("labelBackground$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		labelForeground$1LBL = new LabelController("labelForeground$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		labelLayoutData$1LBL = new LabelController("labelLayoutData$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		paragraphsSeparated$1LBL = new LabelController("paragraphsSeparated$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		parseTags$1LBL = new LabelController("parseTags$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createParagraphsSeparated(ControllerCore genCode) {
		...
		paragraphsSeparatedTXT = new TextController("paragraphsSeparated", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createParseTags(ControllerCore genCode) {
		...
		parseTagsTXT = new TextController("parseTags", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
