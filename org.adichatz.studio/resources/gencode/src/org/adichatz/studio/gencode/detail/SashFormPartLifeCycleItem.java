...
public class SashFormPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameSashFormPART$1(ControllerCore genCode) {
		...
		controllerClassNameSashFormPART$1HL = new HyperlinkController("controllerClassNameSashFormPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURISashFormPART$1(ControllerCore genCode) {
		...
		entityURISashFormPART$1HL = new HyperlinkController("entityURISashFormPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
