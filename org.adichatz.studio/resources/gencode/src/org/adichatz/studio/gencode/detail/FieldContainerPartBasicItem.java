/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:30 CET 2019
 *
 * 				+----------------------------------------+
...
public class FieldContainerPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameFieldContainerPART$1HL.
	private HyperlinkController controllerClassNameFieldContainerPART$1HL;
	...
	// the HyperlinkController entityURIFieldContainerPART$1HL.
	private HyperlinkController entityURIFieldContainerPART$1HL;
	...
	public HyperlinkController createControllerClassNameFieldContainerPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameFieldContainerPART$1HL
		controllerClassNameFieldContainerPART$1HL = new HyperlinkController("controllerClassNameFieldContainerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIFieldContainerPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIFieldContainerPART$1HL
		entityURIFieldContainerPART$1HL = new HyperlinkController("entityURIFieldContainerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
