...
public class RefControlPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates RefControlPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public RefControlPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
