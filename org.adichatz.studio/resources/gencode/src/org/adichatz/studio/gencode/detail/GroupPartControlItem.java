...
public class GroupPartControlItem extends EntityManagerCore {
	 ...
	 */
	public GroupPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
