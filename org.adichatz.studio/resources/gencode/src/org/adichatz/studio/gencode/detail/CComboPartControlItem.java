...
public class CComboPartControlItem extends EntityManagerCore {
	 ...
	 */
	public CComboPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
