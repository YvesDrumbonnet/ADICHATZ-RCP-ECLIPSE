/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:35:22 CEST 2020
 *
 * 				+----------------------------------------+
...
public class SashFormPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates SashFormPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public SashFormPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		weights$1LBL = new LabelController("weights$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createWeights(ControllerCore genCode) {
		...
		weightsTXT = new TextController("weights", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
