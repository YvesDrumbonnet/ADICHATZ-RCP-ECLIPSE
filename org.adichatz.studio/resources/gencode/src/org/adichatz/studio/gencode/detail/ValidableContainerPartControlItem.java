...
public class ValidableContainerPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates ValidableContainerPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public ValidableContainerPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
