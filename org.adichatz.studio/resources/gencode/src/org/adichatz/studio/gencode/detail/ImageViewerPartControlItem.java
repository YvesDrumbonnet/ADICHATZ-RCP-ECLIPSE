...
public class ImageViewerPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates ImageViewerPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public ImageViewerPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		imageStyle$1LBL = new LabelController("imageStyle$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public XjcTextController createImageStyle(ControllerCore genCode) {
		...
		imageStyleTXT = new XjcTextController("imageStyle", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
