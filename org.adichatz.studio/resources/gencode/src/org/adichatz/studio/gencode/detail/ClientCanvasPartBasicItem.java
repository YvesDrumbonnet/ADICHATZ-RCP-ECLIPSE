...
public class ClientCanvasPartBasicItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameClientCanvasPART$1(ControllerCore genCode) {
		...
		controllerClassNameClientCanvasPART$1HL = new OutlineHyperlinkController("controllerClassNameClientCanvasPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIClientCanvasPART$1(ControllerCore genCode) {
		...
		entityURIClientCanvasPART$1HL = new OutlineHyperlinkController("entityURIClientCanvasPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
