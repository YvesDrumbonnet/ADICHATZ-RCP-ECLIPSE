/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:33:51 CEST 2020
 *
 * 				+----------------------------------------+
...
public class ControlPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates ControlPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public ControlPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameControlPART$1(ControllerCore genCode) {
		...
		controllerClassNameControlPART$1HL = new OutlineHyperlinkController("controllerClassNameControlPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
