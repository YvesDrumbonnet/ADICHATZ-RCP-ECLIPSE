...
@AdiResourceURI(URI="adi://org.adichatz.studio/model/CustomizationsMM")
public class CustomizationsMM extends AXjcEntityMetaModel<CustomizationsType> {
	/**
	 * Creates the MetaModel class for CustomizationsMM.
	 *
	 */
	public CustomizationsMM(PluginEntity<?> pluginEntity) {
		super(pluginEntity);
	...
	/**
	 * Create contents for MetaModel CustomizationsMM.
	 */
	public void create(){
		...
		// add one to many for field 'scrolledFormOrClientCanvasOrSection' (parent clause='null')
		XjcEntitySet oneToMany;
		oneToMany = new XjcEntitySet(this, "scrolledFormOrClientCanvasOrSection", null);
		oneToMany.addElementEntity("adi://org.adichatz.studio/model/ScrolledFormMM");
		oneToMany.addElementEntity("adi://org.adichatz.studio/model/ClientCanvasMM");
		...
		oneToMany.addElementEntity("adi://org.adichatz.studio/model/TabularMM");
		...
		oneToMany.addElementEntity("adi://org.adichatz.studio/model/ColumnFieldMM");
		...
		oneToMany.addElementEntity("adi://org.adichatz.studio/model/ToolItemMM");
	 ...
	 */
	@Override
	public Class<CustomizationsType> getBeanClass() {
		return CustomizationsType.class;
	}
	@Override
