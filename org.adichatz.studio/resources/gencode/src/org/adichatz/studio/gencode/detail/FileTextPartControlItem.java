...
public class FileTextPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates FileTextPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public FileTextPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		filterExtension$1LBL = new LabelController("filterExtension$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		filterPath$1LBL = new LabelController("filterPath$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createFilterExtension(ControllerCore genCode) {
		...
		filterExtensionTXT = new TextController("filterExtension", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createFilterPath(ControllerCore genCode) {
		...
		filterPathTXT = new TextController("filterPath", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
