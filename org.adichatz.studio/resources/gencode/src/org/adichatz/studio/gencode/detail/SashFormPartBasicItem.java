/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:35:21 CEST 2020
 *
 * 				+----------------------------------------+
...
public class SashFormPartBasicItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameSashFormPART$1(ControllerCore genCode) {
		...
		controllerClassNameSashFormPART$1HL = new OutlineHyperlinkController("controllerClassNameSashFormPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURISashFormPART$1(ControllerCore genCode) {
		...
		entityURISashFormPART$1HL = new OutlineHyperlinkController("entityURISashFormPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
