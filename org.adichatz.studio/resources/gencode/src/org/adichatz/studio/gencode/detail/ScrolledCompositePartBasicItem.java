/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:47 CET 2019
 *
 * 				+----------------------------------------+
...
public class ScrolledCompositePartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameScrolledCompositePART$1HL.
	private HyperlinkController controllerClassNameScrolledCompositePART$1HL;
	...
	// the HyperlinkController entityURIScrolledCompositePART$1HL.
	private HyperlinkController entityURIScrolledCompositePART$1HL;
	...
	public HyperlinkController createControllerClassNameScrolledCompositePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameScrolledCompositePART$1HL
		controllerClassNameScrolledCompositePART$1HL = new HyperlinkController("controllerClassNameScrolledCompositePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIScrolledCompositePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIScrolledCompositePART$1HL
		entityURIScrolledCompositePART$1HL = new HyperlinkController("entityURIScrolledCompositePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
