...
public class SetPartBasicItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameSetPART$1(ControllerCore genCode) {
		...
		controllerClassNameSetPART$1HL = new HyperlinkController("controllerClassNameSetPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURISetPART$1(ControllerCore genCode) {
		...
		entityURISetPART$1HL = new HyperlinkController("entityURISetPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
