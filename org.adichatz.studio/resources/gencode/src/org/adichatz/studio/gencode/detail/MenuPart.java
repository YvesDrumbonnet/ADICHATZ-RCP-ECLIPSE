...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/MenuPart")
public class MenuPart extends AContainerCore {
	...
	// the OutlineHyperlinkController controllerClassNameMenuPART$1HL.
	private OutlineHyperlinkController controllerClassNameMenuPART$1HL;
	 ...
	 */
	public MenuPart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part MenuPart.
	 *
	 ...
	 *            the param map
	*/
	public MenuPart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		createId(this);
		createControllerClassNameMenuPART$1(this);
	...
	public OutlineHyperlinkController createControllerClassNameMenuPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameMenuPART$1HL
		controllerClassNameMenuPART$1HL = new OutlineHyperlinkController("controllerClassNameMenuPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return controllerClassNameMenuPART$1HL;
	}
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(controllerClassNameMenuPART$1HL);
