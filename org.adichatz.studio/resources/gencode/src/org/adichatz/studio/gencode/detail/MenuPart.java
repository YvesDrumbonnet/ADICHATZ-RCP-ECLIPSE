...
public class MenuPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameMenuPART$1HL.
	private HyperlinkController controllerClassNameMenuPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameMenuPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameMenuPART$1HL
		controllerClassNameMenuPART$1HL = new HyperlinkController("controllerClassNameMenuPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
