/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:52:26 CEST 2020
 *
 * 				+----------------------------------------+
...
public class DateTextPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates DateTextPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public DateTextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameDateTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameDateTextPART$1HL = new OutlineHyperlinkController("controllerClassNameDateTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameDateTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameDateTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameDateTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
