/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:15 CET 2019
 *
 * 				+----------------------------------------+
...
public class DateTextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameDateTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameDateTextPART$1HL = new HyperlinkController("controllerClassNameDateTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameDateTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameDateTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameDateTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
