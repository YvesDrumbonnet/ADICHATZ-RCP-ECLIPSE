/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:51 CET 2019
 *
 * 				+----------------------------------------+
...
public class GroupPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameGroupPART$1HL.
	private HyperlinkController controllerClassNameGroupPART$1HL;
	...
	// the HyperlinkController entityURIGroupPART$1HL.
	private HyperlinkController entityURIGroupPART$1HL;
	...
	public HyperlinkController createControllerClassNameGroupPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameGroupPART$1HL
		controllerClassNameGroupPART$1HL = new HyperlinkController("controllerClassNameGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIGroupPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIGroupPART$1HL
		entityURIGroupPART$1HL = new HyperlinkController("entityURIGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
