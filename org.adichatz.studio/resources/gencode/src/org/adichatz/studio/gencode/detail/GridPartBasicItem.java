/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:34:28 CEST 2020
 *
 * 				+----------------------------------------+
...
public class GridPartBasicItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameGridPART$1(ControllerCore genCode) {
		...
		controllerClassNameGridPART$1HL = new OutlineHyperlinkController("controllerClassNameGridPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIGridPART$1(ControllerCore genCode) {
		...
		entityURIGridPART$1HL = new OutlineHyperlinkController("entityURIGridPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
