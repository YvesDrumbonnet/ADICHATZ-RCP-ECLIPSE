/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:34:45 CEST 2020
 *
 * 				+----------------------------------------+
...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/MenuActionPart")
public class MenuActionPart extends AContainerCore {
	...
	// the OutlineHyperlinkController controllerClassNameMenuActionPART$1HL.
	private OutlineHyperlinkController controllerClassNameMenuActionPART$1HL;
	...
	/**
	 * Instantiates a new MenuActionPart.
	 * 
	 ...
	 */
	public MenuActionPart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part MenuActionPart.
	 *
	 ...
	 *            the param map
	*/
	public MenuActionPart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		createId(this);
		createControllerClassNameMenuActionPART$1(this);
		...
		imageDescriptor$1LBL = new LabelController("imageDescriptor$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "menuAction", "imageDescriptor").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		reflow$1LBL = new LabelController("reflow$1", itemCompositeSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "menuAction", "reflow").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		text$1LBL = new LabelController("text$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "menuAction", "text").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
	...
	public OutlineHyperlinkController createControllerClassNameMenuActionPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameMenuActionPART$1HL
		controllerClassNameMenuActionPART$1HL = new OutlineHyperlinkController("controllerClassNameMenuActionPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return controllerClassNameMenuActionPART$1HL;
	}
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(controllerClassNameMenuActionPART$1HL);
	...
	public BooleanRadioGroupController createReflow(ControllerCore genCode) {
		...
		reflowRG = new BooleanRadioGroupController("reflow", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
