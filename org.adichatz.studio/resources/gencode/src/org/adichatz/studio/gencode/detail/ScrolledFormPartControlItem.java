...
public class ScrolledFormPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates ScrolledFormPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public ScrolledFormPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
