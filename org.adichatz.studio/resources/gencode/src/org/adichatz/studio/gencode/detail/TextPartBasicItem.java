...
public class TextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameTextPART$1HL.
	private HyperlinkController controllerClassNameTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameTextPART$1HL;
	...
	public HyperlinkController createControllerClassNameTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameTextPART$1HL
		controllerClassNameTextPART$1HL = new HyperlinkController("controllerClassNameTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameTextPART$1HL
		fieldBindManagerClassNameTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
