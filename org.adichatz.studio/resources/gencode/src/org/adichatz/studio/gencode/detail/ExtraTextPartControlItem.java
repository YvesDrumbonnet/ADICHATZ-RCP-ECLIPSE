...
public class ExtraTextPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates ExtraTextPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public ExtraTextPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		addRefreshItem$1LBL = new LabelController("addRefreshItem$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public XjcTextController createAddRefreshItem(ControllerCore genCode) {
		...
		addRefreshItemTXT = new XjcTextController("addRefreshItem", getParentController(controlItemSCSCLC), genCode) {
			@Override
