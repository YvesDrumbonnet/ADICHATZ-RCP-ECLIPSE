/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:33:25 CEST 2020
 *
 * 				+----------------------------------------+
...
public class ButtonPartControlItem extends EntityManagerCore {
	 ...
	 */
	public ButtonPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		reflow$1LBL = new LabelController("reflow$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public BooleanRadioGroupController createReflow(ControllerCore genCode) {
		...
		reflowRG = new BooleanRadioGroupController("reflow", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
