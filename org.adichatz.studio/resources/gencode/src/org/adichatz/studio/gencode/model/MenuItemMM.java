...
@AdiResourceURI(URI="adi://org.adichatz.studio/model/MenuItemMM")
public class MenuItemMM extends AXjcEntityMetaModel<MenuItemType> {
	/**
	 * Creates the MetaModel class for MenuItemMM.
	 *
	 */
	public MenuItemMM(PluginEntity<?> pluginEntity) {
		super(pluginEntity);
	...
	/**
	 * Create contents for MetaModel MenuItemMM.
	 */
	public void create(){
	 ...
	 */
	@Override
	public Class<MenuItemType> getBeanClass() {
