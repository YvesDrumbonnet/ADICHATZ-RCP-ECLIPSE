...
public class CompositeSeparatorPartBasicItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameCompositeSeparatorPART$1(ControllerCore genCode) {
		...
		controllerClassNameCompositeSeparatorPART$1HL = new HyperlinkController("controllerClassNameCompositeSeparatorPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
