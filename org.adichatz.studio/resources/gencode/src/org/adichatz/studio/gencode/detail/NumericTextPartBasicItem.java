/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:15 CET 2019
 *
 * 				+----------------------------------------+
...
public class NumericTextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameNumericTextPART$1HL.
	private HyperlinkController controllerClassNameNumericTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameNumericTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameNumericTextPART$1HL;
	...
	public HyperlinkController createControllerClassNameNumericTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameNumericTextPART$1HL
		controllerClassNameNumericTextPART$1HL = new HyperlinkController("controllerClassNameNumericTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameNumericTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameNumericTextPART$1HL
		fieldBindManagerClassNameNumericTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameNumericTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
