...
public class MultiChoicePartLifeCycleItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameMultiChoicePART$1(ControllerCore genCode) {
		...
		controllerClassNameMultiChoicePART$1HL = new OutlineHyperlinkController("controllerClassNameMultiChoicePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameMultiChoicePART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameMultiChoicePART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameMultiChoicePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createLabelProviderClassNameMultiChoicePART$1(ControllerCore genCode) {
		...
		labelProviderClassNameMultiChoicePART$1HL = new OutlineHyperlinkController("labelProviderClassNameMultiChoicePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
