/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:32 CET 2019
 *
 * 				+----------------------------------------+
...
public class FileTextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameFileTextPART$1HL.
	private HyperlinkController controllerClassNameFileTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameFileTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameFileTextPART$1HL;
	...
	public HyperlinkController createControllerClassNameFileTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameFileTextPART$1HL
		controllerClassNameFileTextPART$1HL = new HyperlinkController("controllerClassNameFileTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameFileTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameFileTextPART$1HL
		fieldBindManagerClassNameFileTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameFileTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
