...
public class FileTextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameFileTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameFileTextPART$1HL = new HyperlinkController("controllerClassNameFileTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameFileTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameFileTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameFileTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
