...
public class FileTextPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates FileTextPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public FileTextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameFileTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameFileTextPART$1HL = new OutlineHyperlinkController("controllerClassNameFileTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameFileTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameFileTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameFileTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
