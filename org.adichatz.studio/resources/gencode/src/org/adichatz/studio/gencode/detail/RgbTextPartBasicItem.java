...
public class RgbTextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameRgbTextPART$1HL.
	private HyperlinkController controllerClassNameRgbTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameRgbTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameRgbTextPART$1HL;
	...
	public HyperlinkController createControllerClassNameRgbTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameRgbTextPART$1HL
		controllerClassNameRgbTextPART$1HL = new HyperlinkController("controllerClassNameRgbTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRgbTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameRgbTextPART$1HL
		fieldBindManagerClassNameRgbTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameRgbTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
