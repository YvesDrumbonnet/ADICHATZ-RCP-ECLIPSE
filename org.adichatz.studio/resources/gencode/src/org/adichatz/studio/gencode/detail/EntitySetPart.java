...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/EntitySetPart")
public class EntitySetPart extends AContainerCore {
	...
	// the OutlineHyperlinkController entityURIEntitySetPART$1HL.
	private OutlineHyperlinkController entityURIEntitySetPART$1HL;
	...
	/**
	 * Instantiates a new EntitySetPart.
	 * 
	 ...
	 */
	public EntitySetPart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part EntitySetPart.
	 *
	 ...
	 *            the param map
	*/
	public EntitySetPart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		createId(this);
		createEntityURIEntitySetPART$1(this);
	...
	public OutlineHyperlinkController createEntityURIEntitySetPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController entityURIEntitySetPART$1HL
		entityURIEntitySetPART$1HL = new OutlineHyperlinkController("entityURIEntitySetPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				BooleanSupplier evaluatorENABLED;
				evaluatorENABLED = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EntitySetType) parentController.getEntity().getBean()).getEntityURI();
					}
				};
		...
		return entityURIEntitySetPART$1HL;
	}
	public AdiResourceUriTextController createEntityURI(ControllerCore genCode) {
		...
		entityURITXT = new AdiResourceUriTextController("entityURI", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(entityURIEntitySetPART$1HL);
