/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:53:27 CEST 2020
 *
 * 				+----------------------------------------+
...
public class PGroupPartControlItem extends EntityManagerCore {
	 ...
	 */
	public PGroupPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		imagePosition$1LBL = new LabelController("imagePosition$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		linePosition$1LBL = new LabelController("linePosition$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		togglePosition$1LBL = new LabelController("togglePosition$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		toggleRenderer$1LBL = new LabelController("toggleRenderer$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		toolItemRenderer$1LBL = new LabelController("toolItemRenderer$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createImagePosition(ControllerCore genCode) {
		...
		imagePositionTXT = new TextController("imagePosition", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createLinePosition(ControllerCore genCode) {
		...
		linePositionTXT = new TextController("linePosition", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createTogglePosition(ControllerCore genCode) {
		...
		togglePositionTXT = new TextController("togglePosition", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public CComboController createToggleRenderer(ControllerCore genCode) {
		...
		toggleRendererCCMB = new CComboController("toggleRenderer", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public RadioGroupController createToolItemRenderer(ControllerCore genCode) {
		...
		toolItemRendererRG = new RadioGroupController("toolItemRenderer", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
