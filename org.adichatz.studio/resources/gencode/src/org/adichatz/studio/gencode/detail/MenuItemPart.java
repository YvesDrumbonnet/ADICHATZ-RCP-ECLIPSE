...
public class MenuItemPart extends AContainerCore {
	...
	// the OutlineHyperlinkController controllerClassNameMenuItemPART$1HL.
	private OutlineHyperlinkController controllerClassNameMenuItemPART$1HL;
	...
	*/
	...
	public OutlineHyperlinkController createControllerClassNameMenuItemPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameMenuItemPART$1HL
		controllerClassNameMenuItemPART$1HL = new OutlineHyperlinkController("controllerClassNameMenuItemPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
