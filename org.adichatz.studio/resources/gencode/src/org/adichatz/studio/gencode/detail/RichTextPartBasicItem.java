/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:42 CET 2019
 *
 * 				+----------------------------------------+
...
public class RichTextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameRichTextPART$1HL.
	private HyperlinkController controllerClassNameRichTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameRichTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameRichTextPART$1HL;
	...
	public HyperlinkController createControllerClassNameRichTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameRichTextPART$1HL
		controllerClassNameRichTextPART$1HL = new HyperlinkController("controllerClassNameRichTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRichTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameRichTextPART$1HL
		fieldBindManagerClassNameRichTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameRichTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
