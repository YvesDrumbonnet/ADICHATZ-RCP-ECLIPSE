...
public class CustomGenerationUnitPart extends AContainerCore {
	...
	// the HyperlinkController adiResourceURICustomGenerationUnitPART$1HL.
	private HyperlinkController adiResourceURICustomGenerationUnitPART$1HL;
	...
	// the HyperlinkController scenarioClassNameCustomGenerationUnitPART$1HL.
	private HyperlinkController scenarioClassNameCustomGenerationUnitPART$1HL;
	...
	*/
	...
	public HyperlinkController createAdiResourceURICustomGenerationUnitPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController adiResourceURICustomGenerationUnitPART$1HL
		adiResourceURICustomGenerationUnitPART$1HL = new HyperlinkController("adiResourceURICustomGenerationUnitPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createScenarioClassNameCustomGenerationUnitPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController scenarioClassNameCustomGenerationUnitPART$1HL
		scenarioClassNameCustomGenerationUnitPART$1HL = new HyperlinkController("scenarioClassNameCustomGenerationUnitPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
