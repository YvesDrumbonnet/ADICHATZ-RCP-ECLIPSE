...
public class GridPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameGridPART$1(ControllerCore genCode) {
		...
		controllerClassNameGridPART$1HL = new HyperlinkController("controllerClassNameGridPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIGridPART$1(ControllerCore genCode) {
		...
		entityURIGridPART$1HL = new HyperlinkController("entityURIGridPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
