...
public class FieldContainerPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates FieldContainerPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public FieldContainerPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
