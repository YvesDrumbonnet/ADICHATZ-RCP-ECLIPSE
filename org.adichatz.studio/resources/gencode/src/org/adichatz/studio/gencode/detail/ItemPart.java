...
public class ItemPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameItemPART$1HL.
	private HyperlinkController controllerClassNameItemPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameItemPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameItemPART$1HL
		controllerClassNameItemPART$1HL = new HyperlinkController("controllerClassNameItemPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
