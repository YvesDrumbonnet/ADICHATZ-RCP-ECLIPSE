...
public class MultiChoicePartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates MultiChoicePartControlItem.
	 *
	 * @param context
	 ...
	 */
	public MultiChoicePartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		numberOfColumns$1LBL = new LabelController("numberOfColumns$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		poolQueryResult$1LBL = new LabelController("poolQueryResult$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		popupMaxHeight$1LBL = new LabelController("popupMaxHeight$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		popupMaxWidth$1LBL = new LabelController("popupMaxWidth$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		popupTitle$1LBL = new LabelController("popupTitle$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		popupToolbar$1LBL = new LabelController("popupToolbar$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createNumberOfColumns(ControllerCore genCode) {
		...
		numberOfColumnsTXT = new TextController("numberOfColumns", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createPoolQueryResult(ControllerCore genCode) {
		...
		poolQueryResultTXT = new TextController("poolQueryResult", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createPopupMaxHeight(ControllerCore genCode) {
		...
		popupMaxHeightTXT = new TextController("popupMaxHeight", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createPopupMaxWidth(ControllerCore genCode) {
		...
		popupMaxWidthTXT = new TextController("popupMaxWidth", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createPopupTitle(ControllerCore genCode) {
		...
		popupTitleTXT = new TextController("popupTitle", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createPopupToolbar(ControllerCore genCode) {
		...
		popupToolbarTXT = new TextController("popupToolbar", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
