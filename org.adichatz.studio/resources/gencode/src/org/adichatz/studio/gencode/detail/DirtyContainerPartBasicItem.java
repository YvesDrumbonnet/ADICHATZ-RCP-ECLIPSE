/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:18 CET 2019
 *
 * 				+----------------------------------------+
...
public class DirtyContainerPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameDirtyContainerPART$1HL.
	private HyperlinkController controllerClassNameDirtyContainerPART$1HL;
	...
	// the HyperlinkController entityURIDirtyContainerPART$1HL.
	private HyperlinkController entityURIDirtyContainerPART$1HL;
	...
	public HyperlinkController createControllerClassNameDirtyContainerPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameDirtyContainerPART$1HL
		controllerClassNameDirtyContainerPART$1HL = new HyperlinkController("controllerClassNameDirtyContainerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIDirtyContainerPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIDirtyContainerPART$1HL
		entityURIDirtyContainerPART$1HL = new HyperlinkController("entityURIDirtyContainerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
