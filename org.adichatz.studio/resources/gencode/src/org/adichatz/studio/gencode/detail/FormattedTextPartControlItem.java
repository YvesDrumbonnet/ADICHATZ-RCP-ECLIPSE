...
public class FormattedTextPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates FormattedTextPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public FormattedTextPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		displayPattern$1LBL = new LabelController("displayPattern$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		editPattern$1LBL = new LabelController("editPattern$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		format$1LBL = new LabelController("format$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createDisplayPattern(ControllerCore genCode) {
		...
		displayPatternTXT = new TextController("displayPattern", getParentController(controlItemSCSCLC), genCode) {
			@Override
	...
	public TextController createEditPattern(ControllerCore genCode) {
		...
		editPatternTXT = new TextController("editPattern", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public CComboController createFormat(ControllerCore genCode) {
		...
		formatCCMB = new CComboController("format", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
