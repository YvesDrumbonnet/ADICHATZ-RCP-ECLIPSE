...
public class FieldContainerPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameFieldContainerPART$1(ControllerCore genCode) {
		...
		controllerClassNameFieldContainerPART$1HL = new HyperlinkController("controllerClassNameFieldContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIFieldContainerPART$1(ControllerCore genCode) {
		...
		entityURIFieldContainerPART$1HL = new HyperlinkController("entityURIFieldContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
