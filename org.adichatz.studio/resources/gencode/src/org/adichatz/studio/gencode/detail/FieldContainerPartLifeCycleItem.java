/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:52:41 CEST 2020
 *
 * 				+----------------------------------------+
...
public class FieldContainerPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates FieldContainerPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public FieldContainerPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameFieldContainerPART$1(ControllerCore genCode) {
		...
		controllerClassNameFieldContainerPART$1HL = new OutlineHyperlinkController("controllerClassNameFieldContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIFieldContainerPART$1(ControllerCore genCode) {
		...
		entityURIFieldContainerPART$1HL = new OutlineHyperlinkController("entityURIFieldContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
