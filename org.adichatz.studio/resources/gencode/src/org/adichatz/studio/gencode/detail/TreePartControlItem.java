...
public class TreePartControlItem extends EntityManagerCore {
	 ...
	 */
	public TreePartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		showRoot$1LBL = new LabelController("showRoot$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createShowRoot(ControllerCore genCode) {
		...
		showRootTXT = new TextController("showRoot", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
