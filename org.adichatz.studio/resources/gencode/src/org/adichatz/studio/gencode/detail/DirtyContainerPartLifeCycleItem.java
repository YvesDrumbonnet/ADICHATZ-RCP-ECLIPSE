/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:19 CET 2019
 *
 * 				+----------------------------------------+
...
public class DirtyContainerPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameDirtyContainerPART$1(ControllerCore genCode) {
		...
		controllerClassNameDirtyContainerPART$1HL = new HyperlinkController("controllerClassNameDirtyContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIDirtyContainerPART$1(ControllerCore genCode) {
		...
		entityURIDirtyContainerPART$1HL = new HyperlinkController("entityURIDirtyContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
