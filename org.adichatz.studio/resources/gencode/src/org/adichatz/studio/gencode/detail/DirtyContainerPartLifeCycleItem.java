...
public class DirtyContainerPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates DirtyContainerPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public DirtyContainerPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameDirtyContainerPART$1(ControllerCore genCode) {
		...
		controllerClassNameDirtyContainerPART$1HL = new OutlineHyperlinkController("controllerClassNameDirtyContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIDirtyContainerPART$1(ControllerCore genCode) {
		...
		entityURIDirtyContainerPART$1HL = new OutlineHyperlinkController("entityURIDirtyContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
