...
public class ArgTabFolderPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates ArgTabFolderPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public ArgTabFolderPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
