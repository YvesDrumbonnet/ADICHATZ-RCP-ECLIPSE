...
public class StarRatingPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameStarRatingPART$1HL.
	private HyperlinkController controllerClassNameStarRatingPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameStarRatingPART$1HL.
	private HyperlinkController fieldBindManagerClassNameStarRatingPART$1HL;
	...
	public HyperlinkController createControllerClassNameStarRatingPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameStarRatingPART$1HL
		controllerClassNameStarRatingPART$1HL = new HyperlinkController("controllerClassNameStarRatingPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameStarRatingPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameStarRatingPART$1HL
		fieldBindManagerClassNameStarRatingPART$1HL = new HyperlinkController("fieldBindManagerClassNameStarRatingPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
