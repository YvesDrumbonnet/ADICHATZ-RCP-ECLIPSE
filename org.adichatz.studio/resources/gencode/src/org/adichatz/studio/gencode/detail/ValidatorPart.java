...
public class ValidatorPart extends AContainerCore {
	...
	// the HyperlinkController validatorClassNameValidatorPART$1HL.
	private HyperlinkController validatorClassNameValidatorPART$1HL;
	...
	*/
	...
	public HyperlinkController createValidatorClassNameValidatorPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController validatorClassNameValidatorPART$1HL
		validatorClassNameValidatorPART$1HL = new HyperlinkController("validatorClassNameValidatorPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
