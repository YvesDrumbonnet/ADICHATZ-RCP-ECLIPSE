/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:04 CET 2019
 *
 * 				+----------------------------------------+
...
public class ListDetailContentProviderPart extends AContainerCore {
	...
	// the HyperlinkController adiResourceURIListDetailContentProviderPART$1HL.
	private HyperlinkController adiResourceURIListDetailContentProviderPART$1HL;
	// the AdiResourceUriTextController adiResourceURITXT.
	private AdiResourceUriTextController adiResourceURITXT;
	// the HyperlinkController comparatorClassNameListDetailContentProviderPART$1HL.
	private HyperlinkController comparatorClassNameListDetailContentProviderPART$1HL;
	...
	*/
	...
	public HyperlinkController createAdiResourceURIListDetailContentProviderPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController adiResourceURIListDetailContentProviderPART$1HL
		adiResourceURIListDetailContentProviderPART$1HL = new HyperlinkController("adiResourceURIListDetailContentProviderPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createComparatorClassNameListDetailContentProviderPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController comparatorClassNameListDetailContentProviderPART$1HL
		comparatorClassNameListDetailContentProviderPART$1HL = new HyperlinkController("comparatorClassNameListDetailContentProviderPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
