/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:34:43 CEST 2020
 *
 * 				+----------------------------------------+
...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/ListDetailContentProviderPart")
public class ListDetailContentProviderPart extends AContainerCore {
	...
	// the OutlineHyperlinkController adiResourceURIListDetailContentProviderPART$1HL.
	private OutlineHyperlinkController adiResourceURIListDetailContentProviderPART$1HL;
	// the AdiResourceUriTextController adiResourceURITXT.
	private AdiResourceUriTextController adiResourceURITXT;
	// the OutlineHyperlinkController comparatorClassNameListDetailContentProviderPART$1HL.
	private OutlineHyperlinkController comparatorClassNameListDetailContentProviderPART$1HL;
	...
	/**
	 * Instantiates a new ListDetailContentProviderPart.
	 * 
	 ...
	 */
	public ListDetailContentProviderPart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part ListDetailContentProviderPart.
	 *
	 ...
	 *            the param map
	*/
	public ListDetailContentProviderPart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		createId(this);
		createAdiResourceURIListDetailContentProviderPART$1(this);
		createAdiResourceURI(this);
		createComparatorClassNameListDetailContentProviderPART$1(this);
	...
	public OutlineHyperlinkController createAdiResourceURIListDetailContentProviderPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController adiResourceURIListDetailContentProviderPART$1HL
		adiResourceURIListDetailContentProviderPART$1HL = new OutlineHyperlinkController("adiResourceURIListDetailContentProviderPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				BooleanSupplier evaluatorENABLED;
				evaluatorENABLED = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ListDetailContentProviderType) parentController.getEntity().getBean()).getAdiResourceURI();
					}
				};
		...
		return adiResourceURIListDetailContentProviderPART$1HL;
	}
	public AdiResourceUriTextController createAdiResourceURI(ControllerCore genCode) {
		...
		adiResourceURITXT = new AdiResourceUriTextController("adiResourceURI", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(adiResourceURIListDetailContentProviderPART$1HL);
	...
	public OutlineHyperlinkController createComparatorClassNameListDetailContentProviderPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController comparatorClassNameListDetailContentProviderPART$1HL
		comparatorClassNameListDetailContentProviderPART$1HL = new OutlineHyperlinkController("comparatorClassNameListDetailContentProviderPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return comparatorClassNameListDetailContentProviderPART$1HL;
	}
	public ClassTextController createComparatorClassName(ControllerCore genCode) {
		...
		comparatorClassNameTXT = new ClassTextController("comparatorClassName", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(comparatorClassNameListDetailContentProviderPART$1HL);
