...
public class PShelfItemPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates PShelfItemPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public PShelfItemPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
