	...
	public void createContents() {
		...
		featuresPageFP = new LegacyFormPageController("featuresPage", parentController, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().getForm().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio",
							"adichatzStudio", "scenario.features.formText", ((String) context.getParam("pluginName"))));
			...
			featuresTBMINCL = new IncludeController("featuresTBM", featuresPageFP, new EntityManagerCore(getContext())) {
				...
				public void createContents() {
					...
					if (null != EngineConstants.GENERATOR) {
						pluginResources = null == featuresTBMKeys[0] ? getPluginResources()
								: AdichatzApplication.getPluginResources(featuresTBMKeys[0]);
						instantiateIncludeClass(pluginResources, featuresTBMKeys[2], featuresTBMKeys[1],
								new Class[] { ParamMap.class, IContainerController.class, String.class, AdiContext.class },
								new Object[] { getParamMap(), this, "featuresTBM", context });
					} else
