...
public class StarRatingPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameStarRatingPART$1(ControllerCore genCode) {
		...
		controllerClassNameStarRatingPART$1HL = new HyperlinkController("controllerClassNameStarRatingPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameStarRatingPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameStarRatingPART$1HL = new HyperlinkController("fieldBindManagerClassNameStarRatingPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
