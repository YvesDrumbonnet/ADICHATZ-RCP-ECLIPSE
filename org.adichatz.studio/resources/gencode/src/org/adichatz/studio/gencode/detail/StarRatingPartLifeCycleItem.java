...
public class StarRatingPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates StarRatingPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public StarRatingPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameStarRatingPART$1(ControllerCore genCode) {
		...
		controllerClassNameStarRatingPART$1HL = new OutlineHyperlinkController("controllerClassNameStarRatingPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameStarRatingPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameStarRatingPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameStarRatingPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
