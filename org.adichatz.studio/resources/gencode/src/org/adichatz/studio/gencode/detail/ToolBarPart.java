...
public class ToolBarPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameToolBarPART$1HL.
	private HyperlinkController controllerClassNameToolBarPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameToolBarPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameToolBarPART$1HL
		controllerClassNameToolBarPART$1HL = new HyperlinkController("controllerClassNameToolBarPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
