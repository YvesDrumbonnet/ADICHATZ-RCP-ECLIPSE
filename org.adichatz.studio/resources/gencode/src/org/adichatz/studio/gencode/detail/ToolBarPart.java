...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/ToolBarPart")
public class ToolBarPart extends AContainerCore {
	...
	// the OutlineHyperlinkController controllerClassNameToolBarPART$1HL.
	private OutlineHyperlinkController controllerClassNameToolBarPART$1HL;
	...
	/**
	 * Instantiates a new ToolBarPart.
	 * 
	 ...
	 */
	public ToolBarPart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part ToolBarPart.
	 *
	 ...
	 *            the param map
	*/
	public ToolBarPart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		createControllerClassNameToolBarPART$1(this);
		...
		layoutData$1LBL = new LabelController("layoutData$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "toolBar", "layoutData").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
	...
	public OutlineHyperlinkController createControllerClassNameToolBarPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameToolBarPART$1HL
		controllerClassNameToolBarPART$1HL = new OutlineHyperlinkController("controllerClassNameToolBarPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return controllerClassNameToolBarPART$1HL;
	}
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(controllerClassNameToolBarPART$1HL);
