...
public class SectionPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates SectionPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public SectionPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
