/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:45 CET 2019
 *
 * 				+----------------------------------------+
...
public class CComboPartBasicItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameCComboPART$1(ControllerCore genCode) {
		...
		controllerClassNameCComboPART$1HL = new HyperlinkController("controllerClassNameCComboPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameCComboPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameCComboPART$1HL = new HyperlinkController("fieldBindManagerClassNameCComboPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameCComboPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameCComboPART$1HL = new HyperlinkController("labelProviderClassNameCComboPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
