/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:16 CET 2019
 *
 * 				+----------------------------------------+
...
public class DateTimePartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameDateTimePART$1HL.
	private HyperlinkController controllerClassNameDateTimePART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameDateTimePART$1HL.
	private HyperlinkController fieldBindManagerClassNameDateTimePART$1HL;
	...
	public HyperlinkController createControllerClassNameDateTimePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameDateTimePART$1HL
		controllerClassNameDateTimePART$1HL = new HyperlinkController("controllerClassNameDateTimePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameDateTimePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameDateTimePART$1HL
		fieldBindManagerClassNameDateTimePART$1HL = new HyperlinkController("fieldBindManagerClassNameDateTimePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
