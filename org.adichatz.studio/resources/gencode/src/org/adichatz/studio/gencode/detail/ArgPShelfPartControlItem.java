...
public class ArgPShelfPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates ArgPShelfPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public ArgPShelfPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		displayedValues$1LBL = new LabelController("displayedValues$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		shelfRenderer$1LBL = new LabelController("shelfRenderer$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createDisplayedValues(ControllerCore genCode) {
		...
		displayedValuesTXT = new TextController("displayedValues", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public RadioGroupController createShelfRenderer(ControllerCore genCode) {
		...
		shelfRendererRG = new RadioGroupController("shelfRenderer", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
