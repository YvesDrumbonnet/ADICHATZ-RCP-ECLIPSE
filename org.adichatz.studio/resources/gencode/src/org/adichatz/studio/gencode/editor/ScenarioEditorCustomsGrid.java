/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue May 12 15:04:31 CEST 2020
 *
 * 				+----------------------------------------+
				...
				super.startLifeCycle();
						...
						public void createControl() {
							if (isValid()) {
								action =  new AAction() {
									...
									public void init() {
										super.init();
										setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_OPEN_FILE"));
							...
							super.createControl();
							if (isValid()) {
								getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_OPEN_FILE"));
						...
						public void createControl() {
							if (isValid()) {
								action =  new AAction() {
									...
									public void init() {
										super.init();
										setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_COPY"));
							...
							super.createControl();
							if (isValid()) {
								getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_COPY"));
					...
					deleteCustomScenarioACT = new ActionController("deleteCustomScenario", contextMenuMM, ScenarioEditorCustomsGrid.this) {
						...
						public void createControl() {
							...
							super.createControl();
							if (isValid()) {
								getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_DELETE"));
