...
public class TableColumnPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates TableColumnPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public TableColumnPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
