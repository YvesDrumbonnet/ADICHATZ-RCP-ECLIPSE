...
public class CrossReferencePart extends AContainerCore {
	...
	// the HyperlinkController axmlDetailURICrossReferencePART$1HL.
	private HyperlinkController axmlDetailURICrossReferencePART$1HL;
	// the AdiResourceUriTextController axmlDetailURITXT.
	private AdiResourceUriTextController axmlDetailURITXT;
	// the HyperlinkController axmlQueryURICrossReferencePART$1HL.
	private HyperlinkController axmlQueryURICrossReferencePART$1HL;
	// the AdiResourceUriTextController axmlQueryURITXT.
	private AdiResourceUriTextController axmlQueryURITXT;
	// the HyperlinkController axmlTableURICrossReferencePART$1HL.
	private HyperlinkController axmlTableURICrossReferencePART$1HL;
	...
	*/
	...
	public HyperlinkController createAxmlDetailURICrossReferencePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController axmlDetailURICrossReferencePART$1HL
		axmlDetailURICrossReferencePART$1HL = new HyperlinkController("axmlDetailURICrossReferencePART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createAxmlQueryURICrossReferencePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController axmlQueryURICrossReferencePART$1HL
		axmlQueryURICrossReferencePART$1HL = new HyperlinkController("axmlQueryURICrossReferencePART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createAxmlTableURICrossReferencePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController axmlTableURICrossReferencePART$1HL
		axmlTableURICrossReferencePART$1HL = new HyperlinkController("axmlTableURICrossReferencePART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
