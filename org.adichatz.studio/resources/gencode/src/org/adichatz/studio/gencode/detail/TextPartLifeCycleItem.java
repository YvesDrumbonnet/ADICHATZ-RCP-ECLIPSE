/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:35:41 CEST 2020
 *
 * 				+----------------------------------------+
...
public class TextPartLifeCycleItem extends EntityManagerCore {
	 ...
	 */
	public TextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameTextPART$1HL = new OutlineHyperlinkController("controllerClassNameTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
