...
public class TextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameTextPART$1HL = new HyperlinkController("controllerClassNameTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
