...
public class HelpButtonPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates HelpButtonPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public HelpButtonPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
