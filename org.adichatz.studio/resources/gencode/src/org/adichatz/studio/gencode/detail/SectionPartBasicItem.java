/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:51 CET 2019
 *
 * 				+----------------------------------------+
...
public class SectionPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameSectionPART$1HL.
	private HyperlinkController controllerClassNameSectionPART$1HL;
	...
	// the HyperlinkController entityURISectionPART$1HL.
	private HyperlinkController entityURISectionPART$1HL;
	...
	public HyperlinkController createControllerClassNameSectionPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameSectionPART$1HL
		controllerClassNameSectionPART$1HL = new HyperlinkController("controllerClassNameSectionPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURISectionPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURISectionPART$1HL
		entityURISectionPART$1HL = new HyperlinkController("entityURISectionPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
