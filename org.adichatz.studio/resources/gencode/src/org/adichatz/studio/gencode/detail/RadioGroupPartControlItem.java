...
public class RadioGroupPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates RadioGroupPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public RadioGroupPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		defaultSelection$1LBL = new LabelController("defaultSelection$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createDefaultSelection(ControllerCore genCode) {
		...
		defaultSelectionTXT = new TextController("defaultSelection", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
