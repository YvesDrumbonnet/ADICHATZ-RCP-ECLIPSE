...
public class FormattedTextPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates FormattedTextPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public FormattedTextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameFormattedTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameFormattedTextPART$1HL = new OutlineHyperlinkController("controllerClassNameFormattedTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameFormattedTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameFormattedTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameFormattedTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
