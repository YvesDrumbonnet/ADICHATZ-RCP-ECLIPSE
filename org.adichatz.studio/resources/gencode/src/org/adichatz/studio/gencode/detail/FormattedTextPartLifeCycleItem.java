...
public class FormattedTextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameFormattedTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameFormattedTextPART$1HL = new HyperlinkController("controllerClassNameFormattedTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameFormattedTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameFormattedTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameFormattedTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
