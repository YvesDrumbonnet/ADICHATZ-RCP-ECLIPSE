...
public class ButtonPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates ButtonPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public ButtonPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameButtonPART$1(ControllerCore genCode) {
		...
		controllerClassNameButtonPART$1HL = new OutlineHyperlinkController("controllerClassNameButtonPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
