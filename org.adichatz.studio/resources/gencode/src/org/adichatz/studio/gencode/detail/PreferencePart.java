...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/PreferencePart")
public class PreferencePart extends AContainerCore {
	...
	/**
	 * Instantiates a new PreferencePart.
	 * 
	 ...
	 */
	public PreferencePart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part PreferencePart.
	 *
	 ...
	 *            the param map
	*/
	public PreferencePart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		id$1LBL = new LabelController("id$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "preference", "id").concat(":"));
