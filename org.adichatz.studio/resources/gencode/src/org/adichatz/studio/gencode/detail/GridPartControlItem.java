...
public class GridPartControlItem extends EntityManagerCore {
	 ...
	 */
	public GridPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		columnScrolling$1LBL = new LabelController("columnScrolling$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		rowHeaderVisible$1LBL = new LabelController("rowHeaderVisible$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		selectionEnabled$1LBL = new LabelController("selectionEnabled$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createColumnScrolling(ControllerCore genCode) {
		...
		columnScrollingTXT = new TextController("columnScrolling", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public XjcTextController createRowHeaderVisible(ControllerCore genCode) {
		...
		rowHeaderVisibleTXT = new XjcTextController("rowHeaderVisible", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createSelectionEnabled(ControllerCore genCode) {
		...
		selectionEnabledTXT = new TextController("selectionEnabled", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
