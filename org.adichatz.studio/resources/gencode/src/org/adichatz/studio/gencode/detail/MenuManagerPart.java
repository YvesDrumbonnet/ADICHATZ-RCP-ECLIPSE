...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/MenuManagerPart")
public class MenuManagerPart extends AContainerCore {
	...
	// the OutlineHyperlinkController controllerClassNameMenuManagerPART$1HL.
	private OutlineHyperlinkController controllerClassNameMenuManagerPART$1HL;
	...
	/**
	 * Instantiates a new MenuManagerPart.
	 * 
	 ...
	 */
	public MenuManagerPart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part MenuManagerPart.
	 *
	 ...
	 *            the param map
	*/
	public MenuManagerPart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		createControllerClassNameMenuManagerPART$1(this);
	...
	public OutlineHyperlinkController createControllerClassNameMenuManagerPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameMenuManagerPART$1HL
		controllerClassNameMenuManagerPART$1HL = new OutlineHyperlinkController("controllerClassNameMenuManagerPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return controllerClassNameMenuManagerPART$1HL;
	}
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(controllerClassNameMenuManagerPART$1HL);
