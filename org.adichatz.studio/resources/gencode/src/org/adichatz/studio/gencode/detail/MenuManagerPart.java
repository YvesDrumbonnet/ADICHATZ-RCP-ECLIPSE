...
public class MenuManagerPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameMenuManagerPART$1HL.
	private HyperlinkController controllerClassNameMenuManagerPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameMenuManagerPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameMenuManagerPART$1HL
		controllerClassNameMenuManagerPART$1HL = new HyperlinkController("controllerClassNameMenuManagerPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
