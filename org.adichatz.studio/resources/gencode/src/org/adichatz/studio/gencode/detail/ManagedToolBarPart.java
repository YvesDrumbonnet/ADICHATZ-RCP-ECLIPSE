...
public class ManagedToolBarPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameManagedToolBarPART$1HL.
	private HyperlinkController controllerClassNameManagedToolBarPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameManagedToolBarPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameManagedToolBarPART$1HL
		controllerClassNameManagedToolBarPART$1HL = new HyperlinkController("controllerClassNameManagedToolBarPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
