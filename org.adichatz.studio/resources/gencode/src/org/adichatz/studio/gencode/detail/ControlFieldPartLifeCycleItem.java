...
public class ControlFieldPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameControlFieldPART$1(ControllerCore genCode) {
		...
		controllerClassNameControlFieldPART$1HL = new HyperlinkController("controllerClassNameControlFieldPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameControlFieldPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameControlFieldPART$1HL = new HyperlinkController("fieldBindManagerClassNameControlFieldPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
