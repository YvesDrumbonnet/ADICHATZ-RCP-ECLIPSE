...
public class ColumnFieldPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates ColumnFieldPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public ColumnFieldPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
