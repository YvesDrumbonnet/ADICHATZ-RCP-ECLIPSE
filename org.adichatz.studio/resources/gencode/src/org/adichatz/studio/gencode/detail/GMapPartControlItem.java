...
public class GMapPartControlItem extends EntityManagerCore {
	 ...
	 */
	public GMapPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		addMarker$1LBL = new LabelController("addMarker$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		changeCoordinates$1LBL = new LabelController("changeCoordinates$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		mapTypeControl$1LBL = new LabelController("mapTypeControl$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		mapTypeId$1LBL = new LabelController("mapTypeId$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		toolBarStyle$1LBL = new LabelController("toolBarStyle$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createAddMarker(ControllerCore genCode) {
		...
		addMarkerTXT = new TextController("addMarker", getParentController(controlItemSCSCLC), genCode) {
			@Override
	...
	public TextController createChangeCoordinates(ControllerCore genCode) {
		...
		changeCoordinatesTXT = new TextController("changeCoordinates", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createMapTypeControl(ControllerCore genCode) {
		...
		mapTypeControlTXT = new TextController("mapTypeControl", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public CComboController createMapTypeId(ControllerCore genCode) {
		...
		mapTypeIdCCMB = new CComboController("mapTypeId", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public XjcTextController createToolBarStyle(ControllerCore genCode) {
		...
		toolBarStyleTXT = new XjcTextController("toolBarStyle", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
