/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:34:37 CEST 2020
 *
 * 				+----------------------------------------+
...
public class ImageViewerPartBasicItem extends EntityManagerCore {
	...
	// the OutlineHyperlinkController controllerClassNameImageViewerPART$1HL.
	private OutlineHyperlinkController controllerClassNameImageViewerPART$1HL;
	...
	// the OutlineHyperlinkController fieldBindManagerClassNameImageViewerPART$1HL.
	private OutlineHyperlinkController fieldBindManagerClassNameImageViewerPART$1HL;
	...
	// the LabelController imageStyle$1LBL.
	private LabelController imageStyle$1LBL;
	// the XjcTextController imageStyleTXT.
	private XjcTextController imageStyleTXT;
	// the LabelController imageType$1LBL.
	private LabelController imageType$1LBL;
	// the RadioGroupController imageTypeRG.
	private RadioGroupController imageTypeRG;
	...
	/**
	 * Creates ImageViewerPartBasicItem.
	 *
	 * @param context
	 ...
	 */
	public ImageViewerPartBasicItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		fitCanvas$1LBL = new LabelController("fitCanvas$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		// Creates control for LabelController imageStyle$1LBL
		imageStyle$1LBL = new LabelController("imageStyle$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "imageViewer", "imageStyle").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createImageStyle(this);
		// Creates control for LabelController imageType$1LBL
		imageType$1LBL = new LabelController("imageType$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "imageViewer", "imageType").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createImageType(this);
		...
		toolBarStyle$1LBL = new LabelController("toolBarStyle$1", basicItemSCSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "imageViewer", "toolBarStyle").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getAdditionalCode();
					}
				};
	...
	public TextController createRef(ControllerCore genCode) {
		...
		refTXT = new TextController("ref", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getRef();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("ref");
	...
	public ColorController createBackground(ControllerCore genCode) {
		...
		backgroundTXT = new ColorController("background", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getBackground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createBackgroundImage(ControllerCore genCode) {
		...
		backgroundImageTXT = new TextController("backgroundImage", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getBackgroundImage();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createBounds(ControllerCore genCode) {
		...
		boundsTXT = new TextController("bounds", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getBounds();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("bounds");
	...
	public TextController createCapture(ControllerCore genCode) {
		...
		captureTXT = new TextController("capture", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getCapture();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("capture");
	...
	public OutlineHyperlinkController createControllerClassNameImageViewerPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameImageViewerPART$1HL
		controllerClassNameImageViewerPART$1HL = new OutlineHyperlinkController("controllerClassNameImageViewerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getControllerClassName();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createControlValueType(ControllerCore genCode) {
		...
		controlValueTypeTXT = new TextController("controlValueType", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getControlValueType();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createEnabled(ControllerCore genCode) {
		...
		enabledTXT = new XjcTextController("enabled", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getEnabled();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("enabled");
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameImageViewerPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController fieldBindManagerClassNameImageViewerPART$1HL
		fieldBindManagerClassNameImageViewerPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameImageViewerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public ClassTextController createFieldBindManagerClassName(ControllerCore genCode) {
		...
		fieldBindManagerClassNameTXT = new ClassTextController("fieldBindManagerClassName", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getFieldBindManagerClassName();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createFitCanvas(ControllerCore genCode) {
		...
		fitCanvasTXT = new XjcTextController("fitCanvas", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getFitCanvas();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createFocus(ControllerCore genCode) {
		...
		focusTXT = new TextController("focus", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getFocus();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("focus");
	...
	public FontController createFont(ControllerCore genCode) {
		...
		fontTXT = new FontController("font", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getFont();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("font");
	...
	public TextController createForceBinding(ControllerCore genCode) {
		...
		forceBindingTXT = new TextController("forceBinding", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getForceBinding();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public ColorController createForeground(ControllerCore genCode) {
		...
		foregroundTXT = new ColorController("foreground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getForeground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createImageStyle(ControllerCore genCode) {
		// Creates control for XjcTextController imageStyleTXT
		imageStyleTXT = new XjcTextController("imageStyle", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(imageStyle$1LBL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getImageStyle();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("imageStyle");
				super.initialize();
			}
			@Override
			public void createControl() {
		...
		return imageStyleTXT;
	}
	public RadioGroupController createImageType(ControllerCore genCode) {
		// Creates control for RadioGroupController imageTypeRG
		imageTypeRG = new RadioGroupController("imageType", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(imageType$1LBL);
				setProperty("imageType");
				super.initialize();
			}
			@Override
			public void createControl() {
				if (isValid()) {
					labelProvider = new LabelProvider() {
						public String getText(Object element) {
							return ((ImageTypeEnum) element).value();
						}
					};
				}
				super.createControl();
			...
			public List getValues() {
				return Arrays.asList(ImageTypeEnum.class.getEnumConstants());
			}
		};
		return imageTypeRG;
	}
	public ColorController createLabelBackground(ControllerCore genCode) {
		...
		labelBackgroundTXT = new ColorController("labelBackground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLabelBackground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public FontController createLabelFont(ControllerCore genCode) {
		...
		labelFontTXT = new FontController("labelFont", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLabelFont();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public ColorController createLabelForeground(ControllerCore genCode) {
		...
		labelForegroundTXT = new ColorController("labelForeground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLabelForeground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLabelLayoutData(ControllerCore genCode) {
		...
		labelLayoutDataTXT = new TextController("labelLayoutData", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLabelLayoutData();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLabelText(ControllerCore genCode) {
		...
		labelTextTXT = new TextController("labelText", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLabelText();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createLayoutData(ControllerCore genCode) {
		...
		layoutDataTXT = new XjcTextController("layoutData", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLayoutData();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLazyFetches(ControllerCore genCode) {
		...
		lazyFetchesTXT = new TextController("lazyFetches", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLazyFetches();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLinkedControl(ControllerCore genCode) {
		...
		linkedControlTXT = new TextController("linkedControl", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLinkedControl();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLocation(ControllerCore genCode) {
		...
		locationTXT = new TextController("location", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getLocation();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public BooleanRadioGroupController createMandatory(ControllerCore genCode) {
		...
		mandatoryRG = new BooleanRadioGroupController("mandatory", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).isMandatory();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createMenu(ControllerCore genCode) {
		...
		menuTXT = new TextController("menu", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getMenu();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("menu");
	...
	public BooleanRadioGroupController createNoLabel(ControllerCore genCode) {
		...
		noLabelRG = new BooleanRadioGroupController("noLabel", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).isNoLabel();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("noLabel");
	...
	public TextController createRedraw(ControllerCore genCode) {
		...
		redrawTXT = new TextController("redraw", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getRedraw();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("redraw");
	...
	public TextController createSize(ControllerCore genCode) {
		...
		sizeTXT = new TextController("size", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getSize();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("size");
	...
	public XjcTextController createStyle(ControllerCore genCode) {
		...
		styleTXT = new XjcTextController("style", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getStyle();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("style");
	...
	public XjcTextController createToolBarStyle(ControllerCore genCode) {
		...
		toolBarStyleTXT = new XjcTextController("toolBarStyle", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getToolBarStyle();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createToolTipText(ControllerCore genCode) {
		...
		toolTipTextTXT = new TextController("toolTipText", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getToolTipText();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createVisible(ControllerCore genCode) {
		...
		visibleTXT = new XjcTextController("visible", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getVisible();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("visible");
	...
	public CodeTextController createConvertModelToTarget(ControllerCore genCode) {
		...
		convertModelToTargetTXT = new CodeTextController("convertModelToTarget", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getConvertModelToTarget();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public CodeTextController createConvertTargetToModel(ControllerCore genCode) {
		...
		convertTargetToModelTXT = new CodeTextController("convertTargetToModel", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getConvertTargetToModel();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public CodeTextController createInitialValue(ControllerCore genCode) {
		...
		initialValueTXT = new CodeTextController("initialValue", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ImageViewerType) getEntity().getBean()).getInitialValue();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
