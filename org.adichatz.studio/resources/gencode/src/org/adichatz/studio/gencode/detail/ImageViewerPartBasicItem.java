/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:57 CET 2019
 *
 * 				+----------------------------------------+
...
public class ImageViewerPartBasicItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameImageViewerPART$1(ControllerCore genCode) {
		...
		controllerClassNameImageViewerPART$1HL = new HyperlinkController("controllerClassNameImageViewerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameImageViewerPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameImageViewerPART$1HL = new HyperlinkController("fieldBindManagerClassNameImageViewerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
