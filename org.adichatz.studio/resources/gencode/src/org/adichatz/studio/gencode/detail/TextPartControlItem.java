...
public class TextPartControlItem extends EntityManagerCore {
	 ...
	 */
	public TextPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		proposals$1LBL = new LabelController("proposals$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createProposals(ControllerCore genCode) {
		...
		proposalsTXT = new TextController("proposals", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
