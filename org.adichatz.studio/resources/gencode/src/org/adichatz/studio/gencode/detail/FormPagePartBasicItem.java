/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:36 CET 2019
 *
 * 				+----------------------------------------+
...
public class FormPagePartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController bindingServiceClassNameFormPagePART$1HL.
	private HyperlinkController bindingServiceClassNameFormPagePART$1HL;
	...
	// the HyperlinkController controllerClassNameFormPagePART$1HL.
	private HyperlinkController controllerClassNameFormPagePART$1HL;
	...
	// the HyperlinkController entityURIFormPagePART$1HL.
	private HyperlinkController entityURIFormPagePART$1HL;
	...
	public HyperlinkController createBindingServiceClassNameFormPagePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController bindingServiceClassNameFormPagePART$1HL
		bindingServiceClassNameFormPagePART$1HL = new HyperlinkController("bindingServiceClassNameFormPagePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameFormPagePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameFormPagePART$1HL
		controllerClassNameFormPagePART$1HL = new HyperlinkController("controllerClassNameFormPagePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIFormPagePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIFormPagePART$1HL
		entityURIFormPagePART$1HL = new HyperlinkController("entityURIFormPagePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
