...
public class OneToManyPart extends AContainerCore {
	...
	// the HyperlinkController entityURIOneToManyPART$1HL.
	private HyperlinkController entityURIOneToManyPART$1HL;
	...
	*/
	...
	public HyperlinkController createEntityURIOneToManyPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIOneToManyPART$1HL
		entityURIOneToManyPART$1HL = new HyperlinkController("entityURIOneToManyPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
