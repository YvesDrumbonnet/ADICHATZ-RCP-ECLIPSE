/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:38 CET 2019
 *
 * 				+----------------------------------------+
...
public class ArgPShelfPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameArgPShelfPART$1HL.
	private HyperlinkController controllerClassNameArgPShelfPART$1HL;
	...
	// the HyperlinkController entityURIArgPShelfPART$1HL.
	private HyperlinkController entityURIArgPShelfPART$1HL;
	...
	// the HyperlinkController labelProviderClassNameArgPShelfPART$1HL.
	private HyperlinkController labelProviderClassNameArgPShelfPART$1HL;
	...
	public HyperlinkController createControllerClassNameArgPShelfPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameArgPShelfPART$1HL
		controllerClassNameArgPShelfPART$1HL = new HyperlinkController("controllerClassNameArgPShelfPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIArgPShelfPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIArgPShelfPART$1HL
		entityURIArgPShelfPART$1HL = new HyperlinkController("entityURIArgPShelfPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameArgPShelfPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController labelProviderClassNameArgPShelfPART$1HL
		labelProviderClassNameArgPShelfPART$1HL = new HyperlinkController("labelProviderClassNameArgPShelfPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
