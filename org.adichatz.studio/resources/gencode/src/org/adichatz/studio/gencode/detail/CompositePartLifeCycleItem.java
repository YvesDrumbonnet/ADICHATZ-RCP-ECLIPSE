...
public class CompositePartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates CompositePartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public CompositePartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameCompositePART$1(ControllerCore genCode) {
		...
		controllerClassNameCompositePART$1HL = new OutlineHyperlinkController("controllerClassNameCompositePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURICompositePART$1(ControllerCore genCode) {
		...
		entityURICompositePART$1HL = new OutlineHyperlinkController("entityURICompositePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
