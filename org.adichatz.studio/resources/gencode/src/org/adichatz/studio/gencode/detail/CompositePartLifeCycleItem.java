...
public class CompositePartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameCompositePART$1(ControllerCore genCode) {
		...
		controllerClassNameCompositePART$1HL = new HyperlinkController("controllerClassNameCompositePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURICompositePART$1(ControllerCore genCode) {
		...
		entityURICompositePART$1HL = new HyperlinkController("entityURICompositePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
