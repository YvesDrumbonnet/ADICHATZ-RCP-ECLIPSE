...
public class EntityParamPart extends AContainerCore {
	...
	// the HyperlinkController entityURIEntityParamPART$1HL.
	private HyperlinkController entityURIEntityParamPART$1HL;
	...
	*/
	...
	public HyperlinkController createEntityURIEntityParamPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIEntityParamPART$1HL
		entityURIEntityParamPART$1HL = new HyperlinkController("entityURIEntityParamPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
