...
public class ManyToManyPart extends AContainerCore {
	...
	// the HyperlinkController entityURIManyToManyPART$1HL.
	private HyperlinkController entityURIManyToManyPART$1HL;
	...
	*/
	...
	public HyperlinkController createEntityURIManyToManyPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIManyToManyPART$1HL
		entityURIManyToManyPART$1HL = new HyperlinkController("entityURIManyToManyPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
