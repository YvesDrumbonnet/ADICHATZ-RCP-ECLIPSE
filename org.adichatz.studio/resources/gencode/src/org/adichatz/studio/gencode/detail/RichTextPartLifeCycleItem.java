...
public class RichTextPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates RichTextPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public RichTextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameRichTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameRichTextPART$1HL = new OutlineHyperlinkController("controllerClassNameRichTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameRichTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRichTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameRichTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
