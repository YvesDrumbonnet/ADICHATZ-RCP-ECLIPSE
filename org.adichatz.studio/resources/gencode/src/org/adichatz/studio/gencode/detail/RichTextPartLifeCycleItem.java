/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:43 CET 2019
 *
 * 				+----------------------------------------+
...
public class RichTextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameRichTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameRichTextPART$1HL = new HyperlinkController("controllerClassNameRichTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRichTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRichTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameRichTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
