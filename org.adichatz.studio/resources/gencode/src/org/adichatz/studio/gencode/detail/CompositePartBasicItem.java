/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:00 CET 2019
 *
 * 				+----------------------------------------+
...
public class CompositePartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameCompositePART$1HL.
	private HyperlinkController controllerClassNameCompositePART$1HL;
	...
	// the HyperlinkController entityURICompositePART$1HL.
	private HyperlinkController entityURICompositePART$1HL;
	...
	public HyperlinkController createControllerClassNameCompositePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameCompositePART$1HL
		controllerClassNameCompositePART$1HL = new HyperlinkController("controllerClassNameCompositePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURICompositePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURICompositePART$1HL
		entityURICompositePART$1HL = new HyperlinkController("entityURICompositePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
