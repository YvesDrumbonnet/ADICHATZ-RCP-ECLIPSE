...
public class ComboPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameComboPART$1HL.
	private HyperlinkController controllerClassNameComboPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameComboPART$1HL.
	private HyperlinkController fieldBindManagerClassNameComboPART$1HL;
	...
	// the HyperlinkController labelProviderClassNameComboPART$1HL.
	private HyperlinkController labelProviderClassNameComboPART$1HL;
	...
	public HyperlinkController createControllerClassNameComboPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameComboPART$1HL
		controllerClassNameComboPART$1HL = new HyperlinkController("controllerClassNameComboPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameComboPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameComboPART$1HL
		fieldBindManagerClassNameComboPART$1HL = new HyperlinkController("fieldBindManagerClassNameComboPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameComboPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController labelProviderClassNameComboPART$1HL
		labelProviderClassNameComboPART$1HL = new HyperlinkController("labelProviderClassNameComboPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
