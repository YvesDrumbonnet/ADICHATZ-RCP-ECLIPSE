/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:49 CET 2019
 *
 * 				+----------------------------------------+
...
public class ScrolledFormPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController bindingServiceClassNameScrolledFormPART$1HL.
	private HyperlinkController bindingServiceClassNameScrolledFormPART$1HL;
	...
	// the HyperlinkController controllerClassNameScrolledFormPART$1HL.
	private HyperlinkController controllerClassNameScrolledFormPART$1HL;
	...
	// the HyperlinkController entityURIScrolledFormPART$1HL.
	private HyperlinkController entityURIScrolledFormPART$1HL;
	...
	public HyperlinkController createBindingServiceClassNameScrolledFormPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController bindingServiceClassNameScrolledFormPART$1HL
		bindingServiceClassNameScrolledFormPART$1HL = new HyperlinkController("bindingServiceClassNameScrolledFormPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameScrolledFormPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameScrolledFormPART$1HL
		controllerClassNameScrolledFormPART$1HL = new HyperlinkController("controllerClassNameScrolledFormPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIScrolledFormPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIScrolledFormPART$1HL
		entityURIScrolledFormPART$1HL = new HyperlinkController("entityURIScrolledFormPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
