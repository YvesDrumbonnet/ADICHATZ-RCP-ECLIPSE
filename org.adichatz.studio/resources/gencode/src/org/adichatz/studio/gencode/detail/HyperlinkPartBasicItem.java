...
public class HyperlinkPartBasicItem extends EntityManagerCore {
	...
	// the OutlineHyperlinkController controllerClassNameHyperlinkPART$1HL.
	private OutlineHyperlinkController controllerClassNameHyperlinkPART$1HL;
	...
	// the OutlineHyperlinkController fieldBindManagerClassNameHyperlinkPART$1HL.
	private OutlineHyperlinkController fieldBindManagerClassNameHyperlinkPART$1HL;
	...
	// the OutlineHyperlinkController runnableClassNameHyperlinkPART$1HL.
	private OutlineHyperlinkController runnableClassNameHyperlinkPART$1HL;
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((HyperlinkType) getEntity().getBean()).getAdditionalCode();
					}
				};
	...
	public OutlineHyperlinkController createControllerClassNameHyperlinkPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameHyperlinkPART$1HL
		controllerClassNameHyperlinkPART$1HL = new OutlineHyperlinkController("controllerClassNameHyperlinkPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameHyperlinkPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController fieldBindManagerClassNameHyperlinkPART$1HL
		fieldBindManagerClassNameHyperlinkPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameHyperlinkPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createRunnableClassNameHyperlinkPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController runnableClassNameHyperlinkPART$1HL
		runnableClassNameHyperlinkPART$1HL = new OutlineHyperlinkController("runnableClassNameHyperlinkPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
