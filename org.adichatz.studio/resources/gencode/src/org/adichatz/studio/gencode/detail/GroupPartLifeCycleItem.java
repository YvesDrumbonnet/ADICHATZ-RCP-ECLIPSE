...
public class GroupPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameGroupPART$1(ControllerCore genCode) {
		...
		controllerClassNameGroupPART$1HL = new HyperlinkController("controllerClassNameGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIGroupPART$1(ControllerCore genCode) {
		...
		entityURIGroupPART$1HL = new HyperlinkController("entityURIGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
