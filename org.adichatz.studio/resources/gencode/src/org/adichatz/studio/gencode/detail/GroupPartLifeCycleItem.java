/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:53:01 CEST 2020
 *
 * 				+----------------------------------------+
...
public class GroupPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates GroupPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public GroupPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameGroupPART$1(ControllerCore genCode) {
		...
		controllerClassNameGroupPART$1HL = new OutlineHyperlinkController("controllerClassNameGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIGroupPART$1(ControllerCore genCode) {
		...
		entityURIGroupPART$1HL = new OutlineHyperlinkController("entityURIGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
