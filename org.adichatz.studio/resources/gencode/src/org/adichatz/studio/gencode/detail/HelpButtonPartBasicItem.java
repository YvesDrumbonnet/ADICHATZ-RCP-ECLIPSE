/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:53:03 CEST 2020
 *
 * 				+----------------------------------------+
...
public class HelpButtonPartBasicItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameHelpButtonPART$1(ControllerCore genCode) {
		...
		controllerClassNameHelpButtonPART$1HL = new OutlineHyperlinkController("controllerClassNameHelpButtonPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
