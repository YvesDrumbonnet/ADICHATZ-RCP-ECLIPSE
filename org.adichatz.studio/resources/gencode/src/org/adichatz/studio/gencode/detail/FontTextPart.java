/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:34 CET 2019
 *
 * 				+----------------------------------------+
...
public class FontTextPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameFontTextPART$1HL.
	private HyperlinkController controllerClassNameFontTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameFontTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameFontTextPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameFontTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameFontTextPART$1HL
		controllerClassNameFontTextPART$1HL = new HyperlinkController("controllerClassNameFontTextPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameFontTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameFontTextPART$1HL
		fieldBindManagerClassNameFontTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameFontTextPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
