/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:37 CET 2019
 *
 * 				+----------------------------------------+
...
public class RefTextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameRefTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameRefTextPART$1HL = new HyperlinkController("controllerClassNameRefTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRefTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRefTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameRefTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameRefTextPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameRefTextPART$1HL = new HyperlinkController("labelProviderClassNameRefTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
