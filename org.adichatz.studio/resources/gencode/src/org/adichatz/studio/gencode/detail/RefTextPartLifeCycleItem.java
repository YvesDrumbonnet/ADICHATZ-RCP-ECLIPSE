/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:53:45 CEST 2020
 *
 * 				+----------------------------------------+
...
public class RefTextPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates RefTextPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public RefTextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameRefTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameRefTextPART$1HL = new OutlineHyperlinkController("controllerClassNameRefTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameRefTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRefTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameRefTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createLabelProviderClassNameRefTextPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameRefTextPART$1HL = new OutlineHyperlinkController("labelProviderClassNameRefTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
