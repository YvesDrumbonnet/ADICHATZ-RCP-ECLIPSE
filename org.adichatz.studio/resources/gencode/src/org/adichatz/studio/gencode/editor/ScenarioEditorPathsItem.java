/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Jul 07 08:03:25 CEST 2020
 *
 * 				+----------------------------------------+
...
public class ScenarioEditorPathsItem extends EntityManagerCore {
	protected ATabularCore scenarioEditorPathElementsTable;
	/**
	 * Creates ScenarioEditorPathsItem.
	 *
	 * @param context
	 ...
	 */
	public ScenarioEditorPathsItem(final AdiContext context, IContainerController parentController) {
		super(context);
		// do not create contents when context is null because that means that class is invoked from dynamic part
		if (null != context) {
			coreController = new CTabItemController("pathsItem", parentController, this) {
				@Override
				...
				public void createControl() {
					super.createControl();
					if (isValid()) {
						getItem().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "adichatzStudio", "scenario.paths"));
					}
				}
				@Override
				public EntityInjection getEntityInjection() {
					if (null == entityInjection)
						entityInjection = new EntityInjection(this, getDataAccess().getDataCache().fetchEntity(((ScenarioTree) parentController.getEntity().getBean()).getPathElements()));
	...
	public void createContents(){
		...
		// loads and instantiates the class ScenarioEditorPathElementsTable.
		scenarioEditorPathElementsTable  = new ScenarioEditorPathElementsTable(context, coreController);
	}
}