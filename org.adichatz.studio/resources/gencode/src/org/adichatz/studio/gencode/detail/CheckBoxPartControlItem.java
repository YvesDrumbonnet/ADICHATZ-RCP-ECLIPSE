...
public class CheckBoxPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates CheckBoxPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public CheckBoxPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
