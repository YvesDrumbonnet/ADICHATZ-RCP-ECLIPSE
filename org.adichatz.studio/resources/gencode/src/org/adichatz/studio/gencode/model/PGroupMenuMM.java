...
@AdiResourceURI(URI="adi://org.adichatz.studio/model/PGroupMenuMM")
public class PGroupMenuMM extends AXjcEntityMetaModel<PGroupMenuType> {
	/**
	 * Creates the MetaModel class for PGroupMenuMM.
	 *
	 */
	public PGroupMenuMM(PluginEntity<?> pluginEntity) {
		super(pluginEntity);
	...
	/**
	 * Create contents for MetaModel PGroupMenuMM.
	 */
	public void create(){
		...
		// add one to many for field 'menuItem' (parent clause='null')
		XjcEntitySet oneToMany;
		oneToMany = new XjcEntitySet(this, "menuItem", null);
		oneToMany.addElementEntity("adi://org.adichatz.studio/model/MenuItemMM");
		addSuperFields();
	}
	 ...
	 */
	@Override
	public Class<PGroupMenuType> getBeanClass() {
		return PGroupMenuType.class;
	}
	@Override
