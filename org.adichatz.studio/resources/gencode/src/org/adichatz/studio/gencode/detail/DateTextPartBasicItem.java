/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:14 CET 2019
 *
 * 				+----------------------------------------+
...
public class DateTextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameDateTextPART$1HL.
	private HyperlinkController controllerClassNameDateTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameDateTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameDateTextPART$1HL;
	...
	public HyperlinkController createControllerClassNameDateTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameDateTextPART$1HL
		controllerClassNameDateTextPART$1HL = new HyperlinkController("controllerClassNameDateTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameDateTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameDateTextPART$1HL
		fieldBindManagerClassNameDateTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameDateTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
