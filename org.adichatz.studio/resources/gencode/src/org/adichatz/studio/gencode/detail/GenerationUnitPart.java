...
public class GenerationUnitPart extends AContainerCore {
	...
	// the HyperlinkController adiResourceURIHLHL.
	private HyperlinkController adiResourceURIHLHL;
	...
	*/
	...
	public HyperlinkController createAdiResourceURIHL(ControllerCore genCode) {
		// Creates control for HyperlinkController adiResourceURIHLHL
		adiResourceURIHLHL = new HyperlinkController("adiResourceURIHL", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
