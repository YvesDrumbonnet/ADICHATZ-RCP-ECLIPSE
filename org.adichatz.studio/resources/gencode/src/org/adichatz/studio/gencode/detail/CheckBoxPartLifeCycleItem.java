/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:33:33 CEST 2020
 *
 * 				+----------------------------------------+
...
public class CheckBoxPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates CheckBoxPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public CheckBoxPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameCheckBoxPART$1(ControllerCore genCode) {
		...
		controllerClassNameCheckBoxPART$1HL = new OutlineHyperlinkController("controllerClassNameCheckBoxPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameCheckBoxPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameCheckBoxPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameCheckBoxPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
