...
public class CheckBoxPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameCheckBoxPART$1(ControllerCore genCode) {
		...
		controllerClassNameCheckBoxPART$1HL = new HyperlinkController("controllerClassNameCheckBoxPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameCheckBoxPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameCheckBoxPART$1HL = new HyperlinkController("fieldBindManagerClassNameCheckBoxPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
