...
public class CTabItemPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates CTabItemPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public CTabItemPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
