/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:33:17 CEST 2020
 *
 * 				+----------------------------------------+
...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/ActionPart")
public class ActionPart extends AContainerCore {
	...
	// the OutlineHyperlinkController actionClassNameActionPART$1HL.
	private OutlineHyperlinkController actionClassNameActionPART$1HL;
	// the ClassTextController actionClassNameTXT.
	private ClassTextController actionClassNameTXT;
	// the OutlineHyperlinkController controllerClassNameActionPART$1HL.
	private OutlineHyperlinkController controllerClassNameActionPART$1HL;
	...
	// the LabelController actionCode$1LBL.
	private LabelController actionCode$1LBL;
	// the CodeTextController actionCodeTXT.
	private CodeTextController actionCodeTXT;
	 ...
	 */
	public ActionPart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part ActionPart.
	 *
	 ...
	 *            the param map
	*/
	public ActionPart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		createId(this);
		createActionClassNameActionPART$1(this);
		createActionClassName(this);
		createControllerClassNameActionPART$1(this);
		...
		imageDescriptor$1LBL = new LabelController("imageDescriptor$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "action", "imageDescriptor").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		rank$1LBL = new LabelController("rank$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "action", "rank").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		text$1LBL = new LabelController("text$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "action", "text").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		createValid(this);
		// Creates control for LabelController actionCode$1LBL
		actionCode$1LBL = new LabelController("actionCode$1", itemCompositeSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "action", "actionCode").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createActionCode(this);
	...
	public OutlineHyperlinkController createActionClassNameActionPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController actionClassNameActionPART$1HL
		actionClassNameActionPART$1HL = new OutlineHyperlinkController("actionClassNameActionPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					runnable = new OpenClassEditorRunnable(this);
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "action", "actionClassName").concat(":"));
					getControl().addFocusListener(new XjcFocusListener(this));
				}
			}
		};
		return actionClassNameActionPART$1HL;
	}
	public ClassTextController createActionClassName(ControllerCore genCode) {
		...
		actionClassNameTXT = new ClassTextController("actionClassName", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(actionClassNameActionPART$1HL);
	...
	public OutlineHyperlinkController createControllerClassNameActionPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameActionPART$1HL
		controllerClassNameActionPART$1HL = new OutlineHyperlinkController("controllerClassNameActionPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return controllerClassNameActionPART$1HL;
	}
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(controllerClassNameActionPART$1HL);
	...
	public CodeTextController createActionCode(ControllerCore genCode) {
		// Creates control for CodeTextController actionCodeTXT
		actionCodeTXT = new CodeTextController("actionCode", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(actionCode$1LBL);
				setProperty("actionCode");
				super.initialize();
			}
			@Override
			public void createControl() {
