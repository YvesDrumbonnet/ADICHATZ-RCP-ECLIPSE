/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:37 CET 2019
 *
 * 				+----------------------------------------+
...
public class ActionPart extends AContainerCore {
	...
	// the HyperlinkController actionClassNameActionPART$1HL.
	private HyperlinkController actionClassNameActionPART$1HL;
	// the ClassTextController actionClassNameTXT.
	private ClassTextController actionClassNameTXT;
	// the HyperlinkController controllerClassNameActionPART$1HL.
	private HyperlinkController controllerClassNameActionPART$1HL;
	...
	*/
	...
	public HyperlinkController createActionClassNameActionPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController actionClassNameActionPART$1HL
		actionClassNameActionPART$1HL = new HyperlinkController("actionClassNameActionPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameActionPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameActionPART$1HL
		controllerClassNameActionPART$1HL = new HyperlinkController("controllerClassNameActionPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
