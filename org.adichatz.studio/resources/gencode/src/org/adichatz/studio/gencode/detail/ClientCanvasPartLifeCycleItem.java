/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:53 CET 2019
 *
 * 				+----------------------------------------+
...
public class ClientCanvasPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameClientCanvasPART$1(ControllerCore genCode) {
		...
		controllerClassNameClientCanvasPART$1HL = new HyperlinkController("controllerClassNameClientCanvasPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIClientCanvasPART$1(ControllerCore genCode) {
		...
		entityURIClientCanvasPART$1HL = new HyperlinkController("entityURIClientCanvasPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
