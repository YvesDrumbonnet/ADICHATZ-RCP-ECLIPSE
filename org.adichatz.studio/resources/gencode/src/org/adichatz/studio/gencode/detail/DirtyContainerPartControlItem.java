...
public class DirtyContainerPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates DirtyContainerPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public DirtyContainerPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
