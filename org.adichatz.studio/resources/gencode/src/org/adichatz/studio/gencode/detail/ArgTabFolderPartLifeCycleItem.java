...
public class ArgTabFolderPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameArgTabFolderPART$1(ControllerCore genCode) {
		...
		controllerClassNameArgTabFolderPART$1HL = new HyperlinkController("controllerClassNameArgTabFolderPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIArgTabFolderPART$1(ControllerCore genCode) {
		...
		entityURIArgTabFolderPART$1HL = new HyperlinkController("entityURIArgTabFolderPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameArgTabFolderPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameArgTabFolderPART$1HL = new HyperlinkController("labelProviderClassNameArgTabFolderPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
