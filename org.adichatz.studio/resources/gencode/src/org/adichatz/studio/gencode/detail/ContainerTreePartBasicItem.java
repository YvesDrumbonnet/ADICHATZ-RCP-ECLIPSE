/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:04 CET 2019
 *
 * 				+----------------------------------------+
...
public class ContainerTreePartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController bindingServiceClassNameContainerTreePART$1HL.
	private HyperlinkController bindingServiceClassNameContainerTreePART$1HL;
	...
	// the HyperlinkController entityURIContainerTreePART$1HL.
	private HyperlinkController entityURIContainerTreePART$1HL;
	...
	public HyperlinkController createBindingServiceClassNameContainerTreePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController bindingServiceClassNameContainerTreePART$1HL
		bindingServiceClassNameContainerTreePART$1HL = new HyperlinkController("bindingServiceClassNameContainerTreePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIContainerTreePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIContainerTreePART$1HL
		entityURIContainerTreePART$1HL = new HyperlinkController("entityURIContainerTreePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
