...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/CopyResourcePart")
public class CopyResourcePart extends AContainerCore {
	...
	// the LabelController force$1LBL.
	private LabelController force$1LBL;
	// the CheckBoxController forceCB.
	private CheckBoxController forceCB;
	...
	/**
	 * Instantiates a new CopyResourcePart.
	 * 
	 ...
	 */
	public CopyResourcePart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part CopyResourcePart.
	 *
	 ...
	 *            the param map
	*/
	public CopyResourcePart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		// Creates control for LabelController force$1LBL
		force$1LBL = new LabelController("force$1", itemCompositeSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "copyResource", "force").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		sourceURI$1LBL = new LabelController("sourceURI$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "copyResource", "sourceURI").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
	...
	public CheckBoxController createForce(ControllerCore genCode) {
		// Creates control for CheckBoxController forceCB
		forceCB = new CheckBoxController("force", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(force$1LBL);
				setProperty("force");
				super.initialize();
			}
			@Override
