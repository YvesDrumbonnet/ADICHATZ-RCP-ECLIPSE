/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:21 CET 2019
 *
 * 				+----------------------------------------+
...
public class PShelfItemPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNamePShelfItemPART$1HL.
	private HyperlinkController controllerClassNamePShelfItemPART$1HL;
	...
	// the HyperlinkController entityURIPShelfItemPART$1HL.
	private HyperlinkController entityURIPShelfItemPART$1HL;
	...
	public HyperlinkController createControllerClassNamePShelfItemPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNamePShelfItemPART$1HL
		controllerClassNamePShelfItemPART$1HL = new HyperlinkController("controllerClassNamePShelfItemPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIPShelfItemPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIPShelfItemPART$1HL
		entityURIPShelfItemPART$1HL = new HyperlinkController("entityURIPShelfItemPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
