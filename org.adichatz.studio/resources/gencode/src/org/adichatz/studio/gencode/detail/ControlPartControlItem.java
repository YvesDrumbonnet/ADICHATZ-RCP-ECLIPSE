...
public class ControlPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates ControlPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public ControlPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
