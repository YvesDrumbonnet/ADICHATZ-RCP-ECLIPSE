/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:43 CET 2019
 *
 * 				+----------------------------------------+
...
public class ButtonPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameButtonPART$1HL.
	private HyperlinkController controllerClassNameButtonPART$1HL;
	...
	public HyperlinkController createControllerClassNameButtonPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameButtonPART$1HL
		controllerClassNameButtonPART$1HL = new HyperlinkController("controllerClassNameButtonPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
