/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:34:21 CEST 2020
 *
 * 				+----------------------------------------+
...
public class GMapPartBasicItem extends EntityManagerCore {
	...
	// the OutlineHyperlinkController controllerClassNameGMapPART$1HL.
	private OutlineHyperlinkController controllerClassNameGMapPART$1HL;
	...
	// the OutlineHyperlinkController fieldBindManagerClassNameGMapPART$1HL.
	private OutlineHyperlinkController fieldBindManagerClassNameGMapPART$1HL;
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((GMapType) getEntity().getBean()).getAdditionalCode();
					}
				};
	...
	public OutlineHyperlinkController createControllerClassNameGMapPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameGMapPART$1HL
		controllerClassNameGMapPART$1HL = new OutlineHyperlinkController("controllerClassNameGMapPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameGMapPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController fieldBindManagerClassNameGMapPART$1HL
		fieldBindManagerClassNameGMapPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameGMapPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
