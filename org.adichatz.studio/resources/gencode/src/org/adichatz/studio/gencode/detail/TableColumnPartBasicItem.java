...
public class TableColumnPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameTableColumnPART$1HL.
	private HyperlinkController controllerClassNameTableColumnPART$1HL;
	...
	public HyperlinkController createControllerClassNameTableColumnPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameTableColumnPART$1HL
		controllerClassNameTableColumnPART$1HL = new HyperlinkController("controllerClassNameTableColumnPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
