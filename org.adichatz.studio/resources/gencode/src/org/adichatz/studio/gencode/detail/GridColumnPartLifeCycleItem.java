...
public class GridColumnPartLifeCycleItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameGridColumnPART$1HL.
	private HyperlinkController controllerClassNameGridColumnPART$1HL;
	...
	public HyperlinkController createControllerClassNameGridColumnPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameGridColumnPART$1HL
		controllerClassNameGridColumnPART$1HL = new HyperlinkController("controllerClassNameGridColumnPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
