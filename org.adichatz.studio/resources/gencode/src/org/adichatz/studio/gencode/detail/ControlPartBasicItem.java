...
public class ControlPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameControlPART$1HL.
	private HyperlinkController controllerClassNameControlPART$1HL;
	...
	public HyperlinkController createControllerClassNameControlPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameControlPART$1HL
		controllerClassNameControlPART$1HL = new HyperlinkController("controllerClassNameControlPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
