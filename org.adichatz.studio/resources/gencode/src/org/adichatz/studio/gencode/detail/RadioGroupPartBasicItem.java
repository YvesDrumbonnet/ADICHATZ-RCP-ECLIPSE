...
public class RadioGroupPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameRadioGroupPART$1HL.
	private HyperlinkController controllerClassNameRadioGroupPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameRadioGroupPART$1HL.
	private HyperlinkController fieldBindManagerClassNameRadioGroupPART$1HL;
	...
	// the HyperlinkController labelProviderClassNameRadioGroupPART$1HL.
	private HyperlinkController labelProviderClassNameRadioGroupPART$1HL;
	...
	public HyperlinkController createControllerClassNameRadioGroupPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameRadioGroupPART$1HL
		controllerClassNameRadioGroupPART$1HL = new HyperlinkController("controllerClassNameRadioGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRadioGroupPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameRadioGroupPART$1HL
		fieldBindManagerClassNameRadioGroupPART$1HL = new HyperlinkController("fieldBindManagerClassNameRadioGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameRadioGroupPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController labelProviderClassNameRadioGroupPART$1HL
		labelProviderClassNameRadioGroupPART$1HL = new HyperlinkController("labelProviderClassNameRadioGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
