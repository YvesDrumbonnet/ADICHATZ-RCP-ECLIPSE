/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:51:49 CEST 2020
 *
 * 				+----------------------------------------+
...
public class ArgPShelfPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates ArgPShelfPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public ArgPShelfPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		selection$1LBL = new LabelController("selection$1", lifeCycleItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createControllerClassNameArgPShelfPART$1(ControllerCore genCode) {
		...
		controllerClassNameArgPShelfPART$1HL = new OutlineHyperlinkController("controllerClassNameArgPShelfPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIArgPShelfPART$1(ControllerCore genCode) {
		...
		entityURIArgPShelfPART$1HL = new OutlineHyperlinkController("entityURIArgPShelfPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public OutlineHyperlinkController createLabelProviderClassNameArgPShelfPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameArgPShelfPART$1HL = new OutlineHyperlinkController("labelProviderClassNameArgPShelfPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createSelection(ControllerCore genCode) {
		...
		selectionTXT = new TextController("selection", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
