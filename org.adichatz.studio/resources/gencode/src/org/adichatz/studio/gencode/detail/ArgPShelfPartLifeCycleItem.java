/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:39 CET 2019
 *
 * 				+----------------------------------------+
...
public class ArgPShelfPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameArgPShelfPART$1(ControllerCore genCode) {
		...
		controllerClassNameArgPShelfPART$1HL = new HyperlinkController("controllerClassNameArgPShelfPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIArgPShelfPART$1(ControllerCore genCode) {
		...
		entityURIArgPShelfPART$1HL = new HyperlinkController("entityURIArgPShelfPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameArgPShelfPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameArgPShelfPART$1HL = new HyperlinkController("labelProviderClassNameArgPShelfPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
