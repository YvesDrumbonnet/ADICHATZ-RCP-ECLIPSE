...
public class FormattedTextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameFormattedTextPART$1HL.
	private HyperlinkController controllerClassNameFormattedTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameFormattedTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameFormattedTextPART$1HL;
	...
	public HyperlinkController createControllerClassNameFormattedTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameFormattedTextPART$1HL
		controllerClassNameFormattedTextPART$1HL = new HyperlinkController("controllerClassNameFormattedTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameFormattedTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameFormattedTextPART$1HL
		fieldBindManagerClassNameFormattedTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameFormattedTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
