/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:33:49 CEST 2020
 *
 * 				+----------------------------------------+
...
public class ControlFieldPartBasicItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameControlFieldPART$1(ControllerCore genCode) {
		...
		controllerClassNameControlFieldPART$1HL = new OutlineHyperlinkController("controllerClassNameControlFieldPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameControlFieldPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameControlFieldPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameControlFieldPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public CodeTextController createAdditionalCode(ControllerCore genCode) {
		...
		additionalCodeTXT = new CodeTextController("additionalCode", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((ControlFieldType) getEntity().getBean()).getAdditionalCode();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
