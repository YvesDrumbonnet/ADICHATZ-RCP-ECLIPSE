...
public class SectionPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameSectionPART$1(ControllerCore genCode) {
		...
		controllerClassNameSectionPART$1HL = new HyperlinkController("controllerClassNameSectionPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURISectionPART$1(ControllerCore genCode) {
		...
		entityURISectionPART$1HL = new HyperlinkController("entityURISectionPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
