...
public class SectionPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates SectionPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public SectionPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		clientCapture$1LBL = new LabelController("clientCapture$1", lifeCycleItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createClientCapture(ControllerCore genCode) {
		...
		clientCaptureTXT = new TextController("clientCapture", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
	...
	public OutlineHyperlinkController createControllerClassNameSectionPART$1(ControllerCore genCode) {
		...
		controllerClassNameSectionPART$1HL = new OutlineHyperlinkController("controllerClassNameSectionPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURISectionPART$1(ControllerCore genCode) {
		...
		entityURISectionPART$1HL = new OutlineHyperlinkController("entityURISectionPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
