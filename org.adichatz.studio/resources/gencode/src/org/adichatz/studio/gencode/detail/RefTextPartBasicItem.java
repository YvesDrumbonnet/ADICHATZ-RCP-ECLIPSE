/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:36 CET 2019
 *
 * 				+----------------------------------------+
...
public class RefTextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameRefTextPART$1HL.
	private HyperlinkController controllerClassNameRefTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameRefTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameRefTextPART$1HL;
	...
	// the HyperlinkController labelProviderClassNameRefTextPART$1HL.
	private HyperlinkController labelProviderClassNameRefTextPART$1HL;
	...
	public HyperlinkController createControllerClassNameRefTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameRefTextPART$1HL
		controllerClassNameRefTextPART$1HL = new HyperlinkController("controllerClassNameRefTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRefTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameRefTextPART$1HL
		fieldBindManagerClassNameRefTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameRefTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameRefTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController labelProviderClassNameRefTextPART$1HL
		labelProviderClassNameRefTextPART$1HL = new HyperlinkController("labelProviderClassNameRefTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
