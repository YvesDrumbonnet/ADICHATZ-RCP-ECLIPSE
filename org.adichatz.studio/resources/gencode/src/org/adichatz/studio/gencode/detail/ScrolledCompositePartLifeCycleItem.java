...
public class ScrolledCompositePartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameScrolledCompositePART$1(ControllerCore genCode) {
		...
		controllerClassNameScrolledCompositePART$1HL = new HyperlinkController("controllerClassNameScrolledCompositePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIScrolledCompositePART$1(ControllerCore genCode) {
		...
		entityURIScrolledCompositePART$1HL = new HyperlinkController("entityURIScrolledCompositePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
