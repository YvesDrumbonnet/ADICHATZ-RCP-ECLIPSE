...
public class ScrolledCompositePartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates ScrolledCompositePartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public ScrolledCompositePartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameScrolledCompositePART$1(ControllerCore genCode) {
		...
		controllerClassNameScrolledCompositePART$1HL = new OutlineHyperlinkController("controllerClassNameScrolledCompositePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIScrolledCompositePART$1(ControllerCore genCode) {
		...
		entityURIScrolledCompositePART$1HL = new OutlineHyperlinkController("entityURIScrolledCompositePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
