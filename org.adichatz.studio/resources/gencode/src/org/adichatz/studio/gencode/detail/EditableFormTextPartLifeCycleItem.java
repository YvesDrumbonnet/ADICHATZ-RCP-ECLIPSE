...
public class EditableFormTextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createFieldBindManagerClassNameEditableFormTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameEditableFormTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameEditableFormTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameEditableFormTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameEditableFormTextPART$1HL = new HyperlinkController("controllerClassNameEditableFormTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
