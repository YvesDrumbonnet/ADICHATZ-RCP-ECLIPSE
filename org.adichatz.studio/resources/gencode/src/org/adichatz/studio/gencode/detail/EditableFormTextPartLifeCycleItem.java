...
public class EditableFormTextPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates EditableFormTextPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public EditableFormTextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameEditableFormTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameEditableFormTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameEditableFormTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createControllerClassNameEditableFormTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameEditableFormTextPART$1HL = new OutlineHyperlinkController("controllerClassNameEditableFormTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
