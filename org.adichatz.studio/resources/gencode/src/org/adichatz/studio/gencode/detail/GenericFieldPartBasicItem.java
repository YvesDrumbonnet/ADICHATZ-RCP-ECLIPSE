/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:43 CET 2019
 *
 * 				+----------------------------------------+
...
public class GenericFieldPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameGenericFieldPART$1HL.
	private HyperlinkController controllerClassNameGenericFieldPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameGenericFieldPART$1HL.
	private HyperlinkController fieldBindManagerClassNameGenericFieldPART$1HL;
	...
	public HyperlinkController createControllerClassNameGenericFieldPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameGenericFieldPART$1HL
		controllerClassNameGenericFieldPART$1HL = new HyperlinkController("controllerClassNameGenericFieldPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameGenericFieldPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameGenericFieldPART$1HL
		fieldBindManagerClassNameGenericFieldPART$1HL = new HyperlinkController("fieldBindManagerClassNameGenericFieldPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
