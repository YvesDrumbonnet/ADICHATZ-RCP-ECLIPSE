...
public class CTabItemPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameCTabItemPART$1(ControllerCore genCode) {
		...
		controllerClassNameCTabItemPART$1HL = new HyperlinkController("controllerClassNameCTabItemPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURICTabItemPART$1(ControllerCore genCode) {
		...
		entityURICTabItemPART$1HL = new HyperlinkController("entityURICTabItemPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
