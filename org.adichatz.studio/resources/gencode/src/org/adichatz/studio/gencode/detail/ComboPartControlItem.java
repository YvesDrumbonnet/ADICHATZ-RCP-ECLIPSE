...
public class ComboPartControlItem extends EntityManagerCore {
	 ...
	 */
	public ComboPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
