...
public class RefTextPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates RefTextPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public RefTextPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		textLayoutData$1LBL = new LabelController("textLayoutData$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createTextLayoutData(ControllerCore genCode) {
		...
		textLayoutDataTXT = new TextController("textLayoutData", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
