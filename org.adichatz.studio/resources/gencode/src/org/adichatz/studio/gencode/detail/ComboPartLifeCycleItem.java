/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:33:41 CEST 2020
 *
 * 				+----------------------------------------+
...
public class ComboPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates ComboPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public ComboPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameComboPART$1(ControllerCore genCode) {
		...
		controllerClassNameComboPART$1HL = new OutlineHyperlinkController("controllerClassNameComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameComboPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameComboPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createLabelProviderClassNameComboPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameComboPART$1HL = new OutlineHyperlinkController("labelProviderClassNameComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
