/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:58 CET 2019
 *
 * 				+----------------------------------------+
...
public class ComboPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameComboPART$1(ControllerCore genCode) {
		...
		controllerClassNameComboPART$1HL = new HyperlinkController("controllerClassNameComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameComboPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameComboPART$1HL = new HyperlinkController("fieldBindManagerClassNameComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameComboPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameComboPART$1HL = new HyperlinkController("labelProviderClassNameComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
