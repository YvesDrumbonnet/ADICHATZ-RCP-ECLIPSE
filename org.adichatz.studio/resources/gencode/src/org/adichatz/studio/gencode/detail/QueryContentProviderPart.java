...
public class QueryContentProviderPart extends AContainerCore {
	...
	// the HyperlinkController adiResourceURIQueryContentProviderPART$1HL.
	private HyperlinkController adiResourceURIQueryContentProviderPART$1HL;
	// the AdiResourceUriTextController adiResourceURITXT.
	private AdiResourceUriTextController adiResourceURITXT;
	// the HyperlinkController comparatorClassNameQueryContentProviderPART$1HL.
	private HyperlinkController comparatorClassNameQueryContentProviderPART$1HL;
	...
	*/
	...
	public HyperlinkController createAdiResourceURIQueryContentProviderPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController adiResourceURIQueryContentProviderPART$1HL
		adiResourceURIQueryContentProviderPART$1HL = new HyperlinkController("adiResourceURIQueryContentProviderPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createComparatorClassNameQueryContentProviderPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController comparatorClassNameQueryContentProviderPART$1HL
		comparatorClassNameQueryContentProviderPART$1HL = new HyperlinkController("comparatorClassNameQueryContentProviderPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
