...
public class ImageViewerPartLifeCycleItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameImageViewerPART$1(ControllerCore genCode) {
		...
		controllerClassNameImageViewerPART$1HL = new OutlineHyperlinkController("controllerClassNameImageViewerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameImageViewerPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameImageViewerPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameImageViewerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
