...
public class GMapPartLifeCycleItem extends EntityManagerCore {
	 ...
	 */
	public GMapPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameGMapPART$1(ControllerCore genCode) {
		...
		controllerClassNameGMapPART$1HL = new OutlineHyperlinkController("controllerClassNameGMapPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameGMapPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameGMapPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameGMapPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
