...
public class GMapPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameGMapPART$1(ControllerCore genCode) {
		...
		controllerClassNameGMapPART$1HL = new HyperlinkController("controllerClassNameGMapPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameGMapPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameGMapPART$1HL = new HyperlinkController("fieldBindManagerClassNameGMapPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
