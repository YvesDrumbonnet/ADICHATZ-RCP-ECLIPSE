...
public class RgbTextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameRgbTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameRgbTextPART$1HL = new HyperlinkController("controllerClassNameRgbTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRgbTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRgbTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameRgbTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
