/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:35:18 CEST 2020
 *
 * 				+----------------------------------------+
...
public class RgbTextPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates RgbTextPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public RgbTextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameRgbTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameRgbTextPART$1HL = new OutlineHyperlinkController("controllerClassNameRgbTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameRgbTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRgbTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameRgbTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
