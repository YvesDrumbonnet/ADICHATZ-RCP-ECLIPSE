...
public class EntitySetContentProviderPart extends AContainerCore {
	...
	// the OutlineHyperlinkController adiResourceURIEntitySetContentProviderPART$1HL.
	private OutlineHyperlinkController adiResourceURIEntitySetContentProviderPART$1HL;
	// the AdiResourceUriTextController adiResourceURITXT.
	private AdiResourceUriTextController adiResourceURITXT;
	// the OutlineHyperlinkController comparatorClassNameEntitySetContentProviderPART$1HL.
	private OutlineHyperlinkController comparatorClassNameEntitySetContentProviderPART$1HL;
	...
	*/
	...
	public OutlineHyperlinkController createAdiResourceURIEntitySetContentProviderPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController adiResourceURIEntitySetContentProviderPART$1HL
		adiResourceURIEntitySetContentProviderPART$1HL = new OutlineHyperlinkController("adiResourceURIEntitySetContentProviderPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				BooleanSupplier evaluatorENABLED;
				evaluatorENABLED = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EntitySetContentProviderType) parentController.getEntity().getBean()).getAdiResourceURI();
					}
				};
	...
	public OutlineHyperlinkController createComparatorClassNameEntitySetContentProviderPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController comparatorClassNameEntitySetContentProviderPART$1HL
		comparatorClassNameEntitySetContentProviderPART$1HL = new OutlineHyperlinkController("comparatorClassNameEntitySetContentProviderPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
