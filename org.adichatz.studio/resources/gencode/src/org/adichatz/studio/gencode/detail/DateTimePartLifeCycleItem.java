/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:33:59 CEST 2020
 *
 * 				+----------------------------------------+
...
public class DateTimePartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates DateTimePartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public DateTimePartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameDateTimePART$1(ControllerCore genCode) {
		...
		controllerClassNameDateTimePART$1HL = new OutlineHyperlinkController("controllerClassNameDateTimePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameDateTimePART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameDateTimePART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameDateTimePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
