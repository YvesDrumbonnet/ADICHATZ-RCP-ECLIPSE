/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:17 CET 2019
 *
 * 				+----------------------------------------+
...
public class DateTimePartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameDateTimePART$1(ControllerCore genCode) {
		...
		controllerClassNameDateTimePART$1HL = new HyperlinkController("controllerClassNameDateTimePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameDateTimePART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameDateTimePART$1HL = new HyperlinkController("fieldBindManagerClassNameDateTimePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
