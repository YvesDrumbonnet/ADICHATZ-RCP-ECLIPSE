...
public class HyperlinkPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameHyperlinkPART$1(ControllerCore genCode) {
		...
		controllerClassNameHyperlinkPART$1HL = new HyperlinkController("controllerClassNameHyperlinkPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameHyperlinkPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameHyperlinkPART$1HL = new HyperlinkController("fieldBindManagerClassNameHyperlinkPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createRunnableClassNameHyperlinkPART$1(ControllerCore genCode) {
		...
		runnableClassNameHyperlinkPART$1HL = new HyperlinkController("runnableClassNameHyperlinkPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
