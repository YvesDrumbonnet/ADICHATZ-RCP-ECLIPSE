/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:34:35 CEST 2020
 *
 * 				+----------------------------------------+
...
public class HyperlinkPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates HyperlinkPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public HyperlinkPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameHyperlinkPART$1(ControllerCore genCode) {
		...
		controllerClassNameHyperlinkPART$1HL = new OutlineHyperlinkController("controllerClassNameHyperlinkPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameHyperlinkPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameHyperlinkPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameHyperlinkPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createRunnableClassNameHyperlinkPART$1(ControllerCore genCode) {
		...
		runnableClassNameHyperlinkPART$1HL = new OutlineHyperlinkController("runnableClassNameHyperlinkPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public ClassTextController createRunnableClassName(ControllerCore genCode) {
		...
		runnableClassNameTXT = new ClassTextController("runnableClassName", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
