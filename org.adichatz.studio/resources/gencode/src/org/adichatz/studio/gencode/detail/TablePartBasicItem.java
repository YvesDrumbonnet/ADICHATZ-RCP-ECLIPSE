...
public class TablePartBasicItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameTablePART$1(ControllerCore genCode) {
		...
		controllerClassNameTablePART$1HL = new HyperlinkController("controllerClassNameTablePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURITablePART$1(ControllerCore genCode) {
		...
		entityURITablePART$1HL = new HyperlinkController("entityURITablePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
