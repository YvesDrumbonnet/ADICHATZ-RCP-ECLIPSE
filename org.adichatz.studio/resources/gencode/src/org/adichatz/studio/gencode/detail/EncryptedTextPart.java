...
public class EncryptedTextPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameEncryptedTextPART$1HL.
	private HyperlinkController controllerClassNameEncryptedTextPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameEncryptedTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameEncryptedTextPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameEncryptedTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameEncryptedTextPART$1HL
		controllerClassNameEncryptedTextPART$1HL = new HyperlinkController("controllerClassNameEncryptedTextPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameEncryptedTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameEncryptedTextPART$1HL
		fieldBindManagerClassNameEncryptedTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameEncryptedTextPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
