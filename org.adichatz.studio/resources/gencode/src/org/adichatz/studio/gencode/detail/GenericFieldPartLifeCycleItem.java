...
public class GenericFieldPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates GenericFieldPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public GenericFieldPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameGenericFieldPART$1(ControllerCore genCode) {
		...
		controllerClassNameGenericFieldPART$1HL = new OutlineHyperlinkController("controllerClassNameGenericFieldPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameGenericFieldPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameGenericFieldPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameGenericFieldPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
