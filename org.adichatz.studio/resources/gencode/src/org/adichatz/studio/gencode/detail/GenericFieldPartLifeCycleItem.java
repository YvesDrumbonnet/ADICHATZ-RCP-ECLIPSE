/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:44 CET 2019
 *
 * 				+----------------------------------------+
...
public class GenericFieldPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameGenericFieldPART$1(ControllerCore genCode) {
		...
		controllerClassNameGenericFieldPART$1HL = new HyperlinkController("controllerClassNameGenericFieldPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameGenericFieldPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameGenericFieldPART$1HL = new HyperlinkController("fieldBindManagerClassNameGenericFieldPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
