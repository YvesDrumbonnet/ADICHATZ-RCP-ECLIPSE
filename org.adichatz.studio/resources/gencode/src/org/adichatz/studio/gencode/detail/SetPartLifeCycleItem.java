/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:53 CET 2019
 *
 * 				+----------------------------------------+
...
public class SetPartLifeCycleItem extends EntityManagerCore {
	// the ScrolledCompositeController lifeCycleItemSCSCLC.
	protected ScrolledCompositeController lifeCycleItemSCSCLC;
	// the HyperlinkController controllerClassNameSetPART$1HL.
	private HyperlinkController controllerClassNameSetPART$1HL;
	...
	// the HyperlinkController entityURISetPART$1HL.
	private HyperlinkController entityURISetPART$1HL;
	 ...
	 */
	public SetPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public HyperlinkController createControllerClassNameSetPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameSetPART$1HL
		controllerClassNameSetPART$1HL = new HyperlinkController("controllerClassNameSetPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURISetPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURISetPART$1HL
		entityURISetPART$1HL = new HyperlinkController("entityURISetPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
