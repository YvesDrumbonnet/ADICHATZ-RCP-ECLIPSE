...
public class SetPartLifeCycleItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameSetPART$1(ControllerCore genCode) {
		...
		controllerClassNameSetPART$1HL = new OutlineHyperlinkController("controllerClassNameSetPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURISetPART$1(ControllerCore genCode) {
		...
		entityURISetPART$1HL = new OutlineHyperlinkController("entityURISetPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
