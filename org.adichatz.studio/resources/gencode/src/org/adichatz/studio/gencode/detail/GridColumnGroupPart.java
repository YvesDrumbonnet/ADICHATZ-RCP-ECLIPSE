/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:45 CET 2019
 *
 * 				+----------------------------------------+
...
public class GridColumnGroupPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameGridColumnGroupPART$1HL.
	private HyperlinkController controllerClassNameGridColumnGroupPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameGridColumnGroupPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameGridColumnGroupPART$1HL
		controllerClassNameGridColumnGroupPART$1HL = new HyperlinkController("controllerClassNameGridColumnGroupPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
