/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:19:01 CET 2019
 *
 * 				+----------------------------------------+
...
public class TabularPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameTabularPART$1HL.
	private HyperlinkController controllerClassNameTabularPART$1HL;
	...
	// the HyperlinkController entityURITabularPART$1HL.
	private HyperlinkController entityURITabularPART$1HL;
	...
	public HyperlinkController createControllerClassNameTabularPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameTabularPART$1HL
		controllerClassNameTabularPART$1HL = new HyperlinkController("controllerClassNameTabularPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURITabularPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURITabularPART$1HL
		entityURITabularPART$1HL = new HyperlinkController("entityURITabularPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
