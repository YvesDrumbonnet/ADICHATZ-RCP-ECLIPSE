/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:32 CET 2019
 *
 * 				+----------------------------------------+
...
public class RadioGroupPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameRadioGroupPART$1(ControllerCore genCode) {
		...
		controllerClassNameRadioGroupPART$1HL = new HyperlinkController("controllerClassNameRadioGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRadioGroupPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRadioGroupPART$1HL = new HyperlinkController("fieldBindManagerClassNameRadioGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameRadioGroupPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameRadioGroupPART$1HL = new HyperlinkController("labelProviderClassNameRadioGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
