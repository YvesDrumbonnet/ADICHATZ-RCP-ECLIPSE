/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:53:40 CEST 2020
 *
 * 				+----------------------------------------+
...
public class RadioGroupPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates RadioGroupPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public RadioGroupPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameRadioGroupPART$1(ControllerCore genCode) {
		...
		controllerClassNameRadioGroupPART$1HL = new OutlineHyperlinkController("controllerClassNameRadioGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameRadioGroupPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRadioGroupPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameRadioGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createLabelProviderClassNameRadioGroupPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameRadioGroupPART$1HL = new OutlineHyperlinkController("labelProviderClassNameRadioGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
