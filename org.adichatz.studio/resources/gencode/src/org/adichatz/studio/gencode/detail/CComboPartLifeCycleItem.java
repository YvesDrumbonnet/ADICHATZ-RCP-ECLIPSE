/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:46 CET 2019
 *
 * 				+----------------------------------------+
...
public class CComboPartLifeCycleItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameCComboPART$1HL.
	private HyperlinkController controllerClassNameCComboPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameCComboPART$1HL.
	private HyperlinkController fieldBindManagerClassNameCComboPART$1HL;
	...
	// the HyperlinkController labelProviderClassNameCComboPART$1HL.
	private HyperlinkController labelProviderClassNameCComboPART$1HL;
	...
	/**
	 * Creates CComboPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public CComboPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		poolQueryResult$1LBL = new LabelController("poolQueryResult$1", lifeCycleItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameCComboPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameCComboPART$1HL
		controllerClassNameCComboPART$1HL = new HyperlinkController("controllerClassNameCComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameCComboPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameCComboPART$1HL
		fieldBindManagerClassNameCComboPART$1HL = new HyperlinkController("fieldBindManagerClassNameCComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameCComboPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController labelProviderClassNameCComboPART$1HL
		labelProviderClassNameCComboPART$1HL = new HyperlinkController("labelProviderClassNameCComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createPoolQueryResult(ControllerCore genCode) {
		...
		poolQueryResultTXT = new TextController("poolQueryResult", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
