/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:51:57 CEST 2020
 *
 * 				+----------------------------------------+
...
public class CComboPartLifeCycleItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameCComboPART$1(ControllerCore genCode) {
		...
		controllerClassNameCComboPART$1HL = new OutlineHyperlinkController("controllerClassNameCComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameCComboPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameCComboPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameCComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createLabelProviderClassNameCComboPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameCComboPART$1HL = new OutlineHyperlinkController("labelProviderClassNameCComboPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
