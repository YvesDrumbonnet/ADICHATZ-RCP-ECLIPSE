...
public class RefControlPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameRefControlPART$1(ControllerCore genCode) {
		...
		controllerClassNameRefControlPART$1HL = new HyperlinkController("controllerClassNameRefControlPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameRefControlPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameRefControlPART$1HL = new HyperlinkController("fieldBindManagerClassNameRefControlPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameRefControlPART$1(ControllerCore genCode) {
		...
		labelProviderClassNameRefControlPART$1HL = new HyperlinkController("labelProviderClassNameRefControlPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
