/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:53:30 CEST 2020
 *
 * 				+----------------------------------------+
...
public class PShelfItemPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates PShelfItemPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public PShelfItemPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNamePShelfItemPART$1(ControllerCore genCode) {
		...
		controllerClassNamePShelfItemPART$1HL = new OutlineHyperlinkController("controllerClassNamePShelfItemPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIPShelfItemPART$1(ControllerCore genCode) {
		...
		entityURIPShelfItemPART$1HL = new OutlineHyperlinkController("entityURIPShelfItemPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
