...
public class PShelfItemPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNamePShelfItemPART$1(ControllerCore genCode) {
		...
		controllerClassNamePShelfItemPART$1HL = new HyperlinkController("controllerClassNamePShelfItemPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIPShelfItemPART$1(ControllerCore genCode) {
		...
		entityURIPShelfItemPART$1HL = new HyperlinkController("entityURIPShelfItemPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
