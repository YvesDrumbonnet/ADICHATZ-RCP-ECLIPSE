/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue May 12 17:50:10 CEST 2020
 *
 * 				+----------------------------------------+
	...
	public void createContents() {
		...
		itemCompositeSCLC = new ScrolledCompositeController("itemComposite", coreController, this) {
			...
			public void synchronize() {
				super.synchronize();
				if (isValid()) {
					AEntityListener itemCompositeLSTN$0 = new AEntityListener(itemCompositeSCLC, IEventType.POST_SAVE) {
						@Override
						public void handleEntityEvent(AdiEntityEvent event) {
							XjcBindingService bindingService = (XjcBindingService) genCode.getContext().getRootCore()
									.getController().getBindingService();
							ScenarioFormEditor editor = (ScenarioFormEditor) bindingService.getEditor();
							editor.setProposePluginEntitiesGeneration();
						}
					};
				}
			}
			...
			public void createControl() {
				...
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance()
							.getMessage("org.adichatz.studio", "pluginEntity", "entityURI").concat(":"));
		...
		beanClassName$1LBL = new LabelController("beanClassName$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				...
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance()
							.getMessage("org.adichatz.studio", "pluginEntity", "beanClassName").concat(":"));
				}
			}
		};
		...
		protectPojo$1LBL = new LabelController("protectPojo$1", itemCompositeSCLC, this) {
			...
			public void createControl() {
				...
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance()
							.getMessage("org.adichatz.studio", "pluginEntity", "protectPojo").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		itemCompositeGRP = new GroupController("itemComposite", itemCompositeSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "adichatzStudio",
							"scenario.roles"));
					getComposite().setLayout(new MigLayout("wrap 2", "[align right]10[fill,grow]", "[]"));
		...
		retrieveRoles$1LBL = new LabelController("retrieveRoles$1", itemCompositeGRP, this) {
			...
			public void createControl() {
				...
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance()
							.getMessage("org.adichatz.studio", "pluginEntity", "retrieveRoles").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		mergeRoles$1LBL = new LabelController("mergeRoles$1", itemCompositeGRP, this) {
			...
			public void createControl() {
				...
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance()
							.getMessage("org.adichatz.studio", "pluginEntity", "mergeRoles").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		persistRoles$1LBL = new LabelController("persistRoles$1", itemCompositeGRP, this) {
			...
			public void createControl() {
				...
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance()
							.getMessage("org.adichatz.studio", "pluginEntity", "persistRoles").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		removeRoles$1LBL = new LabelController("removeRoles$1", itemCompositeGRP, this) {
			...
			public void createControl() {
				...
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance()
							.getMessage("org.adichatz.studio", "pluginEntity", "removeRoles").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
