	...
	public void createContents(){
		...
		itemCompositeSCLC = new ScrolledCompositeController("itemComposite", coreController, this) {
			...
			public void synchronize() {
				super.synchronize();
				if (isValid()) {
					AEntityListener itemCompositeLSTN$0 = new AEntityListener("POST_SAVE", itemCompositeSCLC, IEventType.POST_SAVE) {
						@Override
						public void handleEntityEvent(AdiEntityEvent event) {
							XjcBindingService bindingService = (XjcBindingService) genCode.getContext().getRootCore().getController().getBindingService(); 
