...
public class PGroupPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates PGroupPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public PGroupPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNamePGroupPART$1(ControllerCore genCode) {
		...
		controllerClassNamePGroupPART$1HL = new OutlineHyperlinkController("controllerClassNamePGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIPGroupPART$1(ControllerCore genCode) {
		...
		entityURIPGroupPART$1HL = new OutlineHyperlinkController("entityURIPGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
