...
public class PGroupPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNamePGroupPART$1(ControllerCore genCode) {
		...
		controllerClassNamePGroupPART$1HL = new HyperlinkController("controllerClassNamePGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIPGroupPART$1(ControllerCore genCode) {
		...
		entityURIPGroupPART$1HL = new HyperlinkController("entityURIPGroupPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
