...
public class TabularPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameTabularPART$1(ControllerCore genCode) {
		...
		controllerClassNameTabularPART$1HL = new HyperlinkController("controllerClassNameTabularPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURITabularPART$1(ControllerCore genCode) {
		...
		entityURITabularPART$1HL = new HyperlinkController("entityURITabularPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
