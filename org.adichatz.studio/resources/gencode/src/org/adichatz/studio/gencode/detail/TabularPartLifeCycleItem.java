...
public class TabularPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates TabularPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public TabularPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameTabularPART$1(ControllerCore genCode) {
		...
		controllerClassNameTabularPART$1HL = new OutlineHyperlinkController("controllerClassNameTabularPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURITabularPART$1(ControllerCore genCode) {
		...
		entityURITabularPART$1HL = new OutlineHyperlinkController("entityURITabularPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
