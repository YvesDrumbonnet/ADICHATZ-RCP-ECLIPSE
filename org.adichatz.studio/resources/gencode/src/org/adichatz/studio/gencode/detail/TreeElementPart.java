...
public class TreeElementPart extends AContainerCore {
	...
	// the HyperlinkController entityURITreeElementPART$1HL.
	private HyperlinkController entityURITreeElementPART$1HL;
	...
	*/
	...
	public HyperlinkController createEntityURITreeElementPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURITreeElementPART$1HL
		entityURITreeElementPART$1HL = new HyperlinkController("entityURITreeElementPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
