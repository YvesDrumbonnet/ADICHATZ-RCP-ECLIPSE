...
public class CompositePartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates CompositePartControlItem.
	 *
	 * @param context
	 ...
	 */
	public CompositePartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
