...
public class ExtraTextPartBasicItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameExtraTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameExtraTextPART$1HL = new HyperlinkController("controllerClassNameExtraTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameExtraTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameExtraTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameExtraTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
