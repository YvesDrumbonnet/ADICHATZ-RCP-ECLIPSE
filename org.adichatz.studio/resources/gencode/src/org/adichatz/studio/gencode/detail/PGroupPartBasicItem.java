/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:53:26 CEST 2020
 *
 * 				+----------------------------------------+
...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/PGroupPart")
public class PGroupPartBasicItem extends EntityManagerCore {
	...
	// the OutlineHyperlinkController controllerClassNamePGroupPART$1HL.
	private OutlineHyperlinkController controllerClassNamePGroupPART$1HL;
	...
	// the OutlineHyperlinkController entityURIPGroupPART$1HL.
	private OutlineHyperlinkController entityURIPGroupPART$1HL;
	...
	// the LabelController imagePosition$1LBL.
	private LabelController imagePosition$1LBL;
	// the TextController imagePositionTXT.
	private TextController imagePositionTXT;
	...
	// the LabelController linePosition$1LBL.
	private LabelController linePosition$1LBL;
	// the TextController linePositionTXT.
	private TextController linePositionTXT;
	...
	// the LabelController togglePosition$1LBL.
	private LabelController togglePosition$1LBL;
	// the TextController togglePositionTXT.
	private TextController togglePositionTXT;
	// the LabelController toggleRenderer$1LBL.
	private LabelController toggleRenderer$1LBL;
	// the CComboController toggleRendererCCMB.
	private CComboController toggleRendererCCMB;
	// the LabelController toolItemRenderer$1LBL.
	private LabelController toolItemRenderer$1LBL;
	// the RadioGroupController toolItemRendererRG.
	private RadioGroupController toolItemRendererRG;
	 ...
	 */
	public PGroupPartBasicItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		createControllerClassNamePGroupPART$1(this);
		...
		createEntity(this);
		createEntityURIPGroupPART$1(this);
		...
		image$1LBL = new LabelController("image$1", basicItemSCSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "pGroup", "image").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createImage(this);
		// Creates control for LabelController imagePosition$1LBL
		imagePosition$1LBL = new LabelController("imagePosition$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "pGroup", "imagePosition").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createImagePosition(this);
		...
		// Creates control for LabelController linePosition$1LBL
		linePosition$1LBL = new LabelController("linePosition$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "pGroup", "linePosition").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createLinePosition(this);
		...
		createText(this);
		// Creates control for LabelController togglePosition$1LBL
		togglePosition$1LBL = new LabelController("togglePosition$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "pGroup", "togglePosition").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createTogglePosition(this);
		// Creates control for LabelController toggleRenderer$1LBL
		toggleRenderer$1LBL = new LabelController("toggleRenderer$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "pGroup", "toggleRenderer").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createToggleRenderer(this);
		// Creates control for LabelController toolItemRenderer$1LBL
		toolItemRenderer$1LBL = new LabelController("toolItemRenderer$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "pGroup", "toolItemRenderer").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createToolItemRenderer(this);
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getBackground();
					}
				};
	...
	public TextController createBackgroundImage(ControllerCore genCode) {
		...
		backgroundImageTXT = new TextController("backgroundImage", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getBackgroundImage();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createBounds(ControllerCore genCode) {
		...
		boundsTXT = new TextController("bounds", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getBounds();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("bounds");
	...
	public TextController createCapture(ControllerCore genCode) {
		...
		captureTXT = new TextController("capture", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getCapture();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("capture");
	...
	public ColorController createClientBackground(ControllerCore genCode) {
		...
		clientBackgroundTXT = new ColorController("clientBackground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientBackground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientBackgroundImage(ControllerCore genCode) {
		...
		clientBackgroundImageTXT = new TextController("clientBackgroundImage", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientBackgroundImage();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientBounds(ControllerCore genCode) {
		...
		clientBoundsTXT = new TextController("clientBounds", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientBounds();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientCapture(ControllerCore genCode) {
		...
		clientCaptureTXT = new TextController("clientCapture", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientCapture();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientFocus(ControllerCore genCode) {
		...
		clientFocusTXT = new TextController("clientFocus", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientFocus();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public FontController createClientFont(ControllerCore genCode) {
		...
		clientFontTXT = new FontController("clientFont", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientFont();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public ColorController createClientForeground(ControllerCore genCode) {
		...
		clientForegroundTXT = new ColorController("clientForeground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientForeground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientLayoutData(ControllerCore genCode) {
		...
		clientLayoutDataTXT = new TextController("clientLayoutData", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientLayoutData();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientLocation(ControllerCore genCode) {
		...
		clientLocationTXT = new TextController("clientLocation", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientLocation();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientMenu(ControllerCore genCode) {
		...
		clientMenuTXT = new TextController("clientMenu", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientMenu();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientRedraw(ControllerCore genCode) {
		...
		clientRedrawTXT = new TextController("clientRedraw", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientRedraw();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientSize(ControllerCore genCode) {
		...
		clientSizeTXT = new TextController("clientSize", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientSize();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createClientStyle(ControllerCore genCode) {
		...
		clientStyleTXT = new TextController("clientStyle", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getClientStyle();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public OutlineHyperlinkController createControllerClassNamePGroupPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNamePGroupPART$1HL
		controllerClassNamePGroupPART$1HL = new OutlineHyperlinkController("controllerClassNamePGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return controllerClassNamePGroupPART$1HL;
	}
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(controllerClassNamePGroupPART$1HL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getControllerClassName();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createDirtyManagement(ControllerCore genCode) {
		...
		dirtyManagementTXT = new TextController("dirtyManagement", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getDirtyManagement();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createEnabled(ControllerCore genCode) {
		...
		enabledTXT = new XjcTextController("enabled", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getEnabled();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("enabled");
	...
	public TextController createEnableRoles(ControllerCore genCode) {
		...
		enableRolesTXT = new TextController("enableRoles", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getEnableRoles();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createEntity(ControllerCore genCode) {
		...
		entityTXT = new TextController("entity", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getEntity();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("entity");
	...
	public OutlineHyperlinkController createEntityURIPGroupPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController entityURIPGroupPART$1HL
		entityURIPGroupPART$1HL = new OutlineHyperlinkController("entityURIPGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				BooleanSupplier evaluatorENABLED;
				evaluatorENABLED = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) parentController.getEntity().getBean()).getEntityURI();
					}
				};
		...
		return entityURIPGroupPART$1HL;
	}
	public AdiResourceUriTextController createEntityURI(ControllerCore genCode) {
		...
		entityURITXT = new AdiResourceUriTextController("entityURI", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(entityURIPGroupPART$1HL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getEntityURI();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createExpanded(ControllerCore genCode) {
		...
		expandedTXT = new XjcTextController("expanded", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getExpanded();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createFocus(ControllerCore genCode) {
		...
		focusTXT = new TextController("focus", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getFocus();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("focus");
	...
	public FontController createFont(ControllerCore genCode) {
		...
		fontTXT = new FontController("font", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getFont();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("font");
	...
	public ColorController createForeground(ControllerCore genCode) {
		...
		foregroundTXT = new ColorController("foreground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getForeground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createImage(ControllerCore genCode) {
		...
		imageTXT = new TextController("image", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getImage();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("image");
	...
	public TextController createImagePosition(ControllerCore genCode) {
		// Creates control for TextController imagePositionTXT
		imagePositionTXT = new TextController("imagePosition", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(imagePosition$1LBL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getImagePosition();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("imagePosition");
				super.initialize();
			}
			@Override
			public void createControl() {
	...
	public XjcTextController createLayoutData(ControllerCore genCode) {
		...
		layoutDataTXT = new XjcTextController("layoutData", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getLayoutData();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLazyFetches(ControllerCore genCode) {
		...
		lazyFetchesTXT = new TextController("lazyFetches", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getLazyFetches();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLinePosition(ControllerCore genCode) {
		// Creates control for TextController linePositionTXT
		linePositionTXT = new TextController("linePosition", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(linePosition$1LBL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getLinePosition();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("linePosition");
				super.initialize();
			}
			@Override
			public void createControl() {
	...
	public TextController createLocation(ControllerCore genCode) {
		...
		locationTXT = new TextController("location", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getLocation();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createMenu(ControllerCore genCode) {
		...
		menuTXT = new TextController("menu", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getMenu();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("menu");
	...
	public TextController createRedraw(ControllerCore genCode) {
		...
		redrawTXT = new TextController("redraw", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getRedraw();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("redraw");
	...
	public TextController createRef(ControllerCore genCode) {
		...
		refTXT = new TextController("ref", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getRef();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("ref");
	...
	public TextController createSize(ControllerCore genCode) {
		...
		sizeTXT = new TextController("size", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getSize();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("size");
	...
	public TextController createStyle(ControllerCore genCode) {
		...
		styleTXT = new TextController("style", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getStyle();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("style");
	...
	public TextController createText(ControllerCore genCode) {
		...
		textTXT = new TextController("text", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getText();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("text");
	...
	public TextController createTogglePosition(ControllerCore genCode) {
		// Creates control for TextController togglePositionTXT
		togglePositionTXT = new TextController("togglePosition", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(togglePosition$1LBL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getTogglePosition();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("togglePosition");
				super.initialize();
			}
			@Override
			public void createControl() {
		...
		return togglePositionTXT;
	}
	public CComboController createToggleRenderer(ControllerCore genCode) {
		// Creates control for CComboController toggleRendererCCMB
		toggleRendererCCMB = new CComboController("toggleRenderer", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(toggleRenderer$1LBL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getToggleRenderer();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("toggleRenderer");
				super.initialize();
			}
			@Override
			public void createControl() {
				if (isValid()) {
					...
					labelProvider = new LabelProvider() {
						public String getText(Object element) {
							return ((ToggleRendererEnum) element).value();
						}
					};
				}
				super.createControl();
			...
			public List getValues() {
				return Arrays.asList(ToggleRendererEnum.class.getEnumConstants());
			}
		};
		return toggleRendererCCMB;
	}
	public RadioGroupController createToolItemRenderer(ControllerCore genCode) {
		// Creates control for RadioGroupController toolItemRendererRG
		toolItemRendererRG = new RadioGroupController("toolItemRenderer", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(toolItemRenderer$1LBL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getToolItemRenderer();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("toolItemRenderer");
				super.initialize();
			}
			@Override
			public void createControl() {
				if (isValid()) {
					labelProvider = new LabelProvider() {
						public String getText(Object element) {
							return ((ToolItemRendererEnum) element).value();
						}
					};
				}
				super.createControl();
			...
			@Override
			public List getValues() {
				return Arrays.asList(ToolItemRendererEnum.class.getEnumConstants());
			}
		};
		return toolItemRendererRG;
	}
	...
	public TextController createValidRoles(ControllerCore genCode) {
		...
		validRolesTXT = new TextController("validRoles", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getValidRoles();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createVisible(ControllerCore genCode) {
		...
		visibleTXT = new XjcTextController("visible", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getVisible();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("visible");
	...
	public TextController createVisibleRoles(ControllerCore genCode) {
		...
		visibleRolesTXT = new TextController("visibleRoles", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getVisibleRoles();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public CodeTextController createAdditionalCode(ControllerCore genCode) {
		...
		additionalCodeTXT = new CodeTextController("additionalCode", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((PGroupType) getEntity().getBean()).getAdditionalCode();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
