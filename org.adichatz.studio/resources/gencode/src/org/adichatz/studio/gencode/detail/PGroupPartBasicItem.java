/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:18:18 CET 2019
 *
 * 				+----------------------------------------+
...
public class PGroupPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNamePGroupPART$1HL.
	private HyperlinkController controllerClassNamePGroupPART$1HL;
	...
	// the HyperlinkController entityURIPGroupPART$1HL.
	private HyperlinkController entityURIPGroupPART$1HL;
	...
	public HyperlinkController createControllerClassNamePGroupPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNamePGroupPART$1HL
		controllerClassNamePGroupPART$1HL = new HyperlinkController("controllerClassNamePGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIPGroupPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIPGroupPART$1HL
		entityURIPGroupPART$1HL = new HyperlinkController("entityURIPGroupPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
