/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:19:10 CET 2019
 *
 * 				+----------------------------------------+
...
public class ValidableContainerPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameValidableContainerPART$1HL.
	private HyperlinkController controllerClassNameValidableContainerPART$1HL;
	...
	// the HyperlinkController entityURIValidableContainerPART$1HL.
	private HyperlinkController entityURIValidableContainerPART$1HL;
	...
	public HyperlinkController createControllerClassNameValidableContainerPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameValidableContainerPART$1HL
		controllerClassNameValidableContainerPART$1HL = new HyperlinkController("controllerClassNameValidableContainerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIValidableContainerPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURIValidableContainerPART$1HL
		entityURIValidableContainerPART$1HL = new HyperlinkController("entityURIValidableContainerPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
