...
public class HyperlinkPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates HyperlinkPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public HyperlinkPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		runnableCode$1LBL = new LabelController("runnableCode$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public CodeTextController createRunnableCode(ControllerCore genCode) {
		...
		runnableCodeTXT = new CodeTextController("runnableCode", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
