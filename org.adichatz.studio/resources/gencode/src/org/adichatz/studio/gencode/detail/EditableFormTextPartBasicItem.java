/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:34:03 CEST 2020
 *
 * 				+----------------------------------------+
...
public class EditableFormTextPartBasicItem extends EntityManagerCore {
	...
	// the OutlineHyperlinkController fieldBindManagerClassNameEditableFormTextPART$1HL.
	private OutlineHyperlinkController fieldBindManagerClassNameEditableFormTextPART$1HL;
	...
	// the OutlineHyperlinkController controllerClassNameEditableFormTextPART$1HL.
	private OutlineHyperlinkController controllerClassNameEditableFormTextPART$1HL;
	...
	// the LabelController expandURLs$1LBL.
	private LabelController expandURLs$1LBL;
	// the TextController expandURLsTXT.
	private TextController expandURLsTXT;
	...
	// the LabelController paragraphsSeparated$1LBL.
	private LabelController paragraphsSeparated$1LBL;
	// the TextController paragraphsSeparatedTXT.
	private TextController paragraphsSeparatedTXT;
	// the LabelController parseTags$1LBL.
	private LabelController parseTags$1LBL;
	// the TextController parseTagsTXT.
	private TextController parseTagsTXT;
	...
	// the LabelController whitespaceNormalized$1LBL.
	private LabelController whitespaceNormalized$1LBL;
	// the TextController whitespaceNormalizedTXT.
	private TextController whitespaceNormalizedTXT;
	...
	/**
	 * Creates EditableFormTextPartBasicItem.
	 *
	 * @param context
	 ...
	 */
	public EditableFormTextPartBasicItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		createFieldBindManagerClassNameEditableFormTextPART$1(this);
		...
		createControllerClassNameEditableFormTextPART$1(this);
		...
		createEnabled(this);
		// Creates control for LabelController expandURLs$1LBL
		expandURLs$1LBL = new LabelController("expandURLs$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "editableFormText", "expandURLs").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createExpandURLs(this);
		...
		createNoLabel(this);
		// Creates control for LabelController paragraphsSeparated$1LBL
		paragraphsSeparated$1LBL = new LabelController("paragraphsSeparated$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "editableFormText", "paragraphsSeparated").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createParagraphsSeparated(this);
		// Creates control for LabelController parseTags$1LBL
		parseTags$1LBL = new LabelController("parseTags$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "editableFormText", "parseTags").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createParseTags(this);
		...
		text$1LBL = new LabelController("text$1", basicItemSCSCLC, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "editableFormText", "text").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		...
		createVisible(this);
		// Creates control for LabelController whitespaceNormalized$1LBL
		whitespaceNormalized$1LBL = new LabelController("whitespaceNormalized$1", basicItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "editableFormText", "whitespaceNormalized").concat(":"));
					setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
				}
			}
		};
		createWhitespaceNormalized(this);
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLabelFont();
					}
				};
	...
	public TextController createLazyFetches(ControllerCore genCode) {
		...
		lazyFetchesTXT = new TextController("lazyFetches", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLazyFetches();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameEditableFormTextPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController fieldBindManagerClassNameEditableFormTextPART$1HL
		fieldBindManagerClassNameEditableFormTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameEditableFormTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return fieldBindManagerClassNameEditableFormTextPART$1HL;
	}
	public ClassTextController createFieldBindManagerClassName(ControllerCore genCode) {
		...
		fieldBindManagerClassNameTXT = new ClassTextController("fieldBindManagerClassName", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(fieldBindManagerClassNameEditableFormTextPART$1HL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getFieldBindManagerClassName();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public CodeTextController createAdditionalCode(ControllerCore genCode) {
		...
		additionalCodeTXT = new CodeTextController("additionalCode", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getAdditionalCode();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createRef(ControllerCore genCode) {
		...
		refTXT = new TextController("ref", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getRef();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("ref");
	...
	public ColorController createBackground(ControllerCore genCode) {
		...
		backgroundTXT = new ColorController("background", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getBackground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createBackgroundImage(ControllerCore genCode) {
		...
		backgroundImageTXT = new TextController("backgroundImage", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getBackgroundImage();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createBounds(ControllerCore genCode) {
		...
		boundsTXT = new TextController("bounds", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getBounds();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("bounds");
	...
	public TextController createCapture(ControllerCore genCode) {
		...
		captureTXT = new TextController("capture", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getCapture();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("capture");
	...
	public TextController createControlValueType(ControllerCore genCode) {
		...
		controlValueTypeTXT = new TextController("controlValueType", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getControlValueType();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public OutlineHyperlinkController createControllerClassNameEditableFormTextPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameEditableFormTextPART$1HL
		controllerClassNameEditableFormTextPART$1HL = new OutlineHyperlinkController("controllerClassNameEditableFormTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return controllerClassNameEditableFormTextPART$1HL;
	}
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(controllerClassNameEditableFormTextPART$1HL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getControllerClassName();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createEnabled(ControllerCore genCode) {
		...
		enabledTXT = new XjcTextController("enabled", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getEnabled();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("enabled");
	...
	public TextController createExpandURLs(ControllerCore genCode) {
		// Creates control for TextController expandURLsTXT
		expandURLsTXT = new TextController("expandURLs", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(expandURLs$1LBL);
				setProperty("expandURLs");
				super.initialize();
			}
			@Override
			public void createControl() {
	...
	public TextController createFocus(ControllerCore genCode) {
		...
		focusTXT = new TextController("focus", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getFocus();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("focus");
	...
	public FontController createFont(ControllerCore genCode) {
		...
		fontTXT = new FontController("font", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getFont();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("font");
	...
	public TextController createForceBinding(ControllerCore genCode) {
		...
		forceBindingTXT = new TextController("forceBinding", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getForceBinding();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public ColorController createForeground(ControllerCore genCode) {
		...
		foregroundTXT = new ColorController("foreground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getForeground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public ColorController createLabelBackground(ControllerCore genCode) {
		...
		labelBackgroundTXT = new ColorController("labelBackground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLabelBackground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public ColorController createLabelForeground(ControllerCore genCode) {
		...
		labelForegroundTXT = new ColorController("labelForeground", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLabelForeground();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLabelLayoutData(ControllerCore genCode) {
		...
		labelLayoutDataTXT = new TextController("labelLayoutData", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLabelLayoutData();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLabelText(ControllerCore genCode) {
		...
		labelTextTXT = new TextController("labelText", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLabelText();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createLayoutData(ControllerCore genCode) {
		...
		layoutDataTXT = new XjcTextController("layoutData", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLayoutData();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLinkedControl(ControllerCore genCode) {
		...
		linkedControlTXT = new TextController("linkedControl", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLinkedControl();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createLocation(ControllerCore genCode) {
		...
		locationTXT = new TextController("location", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getLocation();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public BooleanRadioGroupController createMandatory(ControllerCore genCode) {
		...
		mandatoryRG = new BooleanRadioGroupController("mandatory", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).isMandatory();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public TextController createMenu(ControllerCore genCode) {
		...
		menuTXT = new TextController("menu", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getMenu();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("menu");
	...
	public BooleanRadioGroupController createNoLabel(ControllerCore genCode) {
		...
		noLabelRG = new BooleanRadioGroupController("noLabel", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).isNoLabel();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("noLabel");
	...
	public TextController createParagraphsSeparated(ControllerCore genCode) {
		// Creates control for TextController paragraphsSeparatedTXT
		paragraphsSeparatedTXT = new TextController("paragraphsSeparated", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(paragraphsSeparated$1LBL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getParagraphsSeparated();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("paragraphsSeparated");
				super.initialize();
			}
			@Override
			public void createControl() {
		...
		return paragraphsSeparatedTXT;
	}
	public TextController createParseTags(ControllerCore genCode) {
		// Creates control for TextController parseTagsTXT
		parseTagsTXT = new TextController("parseTags", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(parseTags$1LBL);
				BooleanSupplier evaluatorVALID;
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getParseTags();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("parseTags");
				super.initialize();
			}
			@Override
			public void createControl() {
	...
	public TextController createRedraw(ControllerCore genCode) {
		...
		redrawTXT = new TextController("redraw", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getRedraw();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("redraw");
	...
	public TextController createSize(ControllerCore genCode) {
		...
		sizeTXT = new TextController("size", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getSize();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("size");
	...
	public XjcTextController createStyle(ControllerCore genCode) {
		...
		styleTXT = new XjcTextController("style", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getStyle();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("style");
	...
	public TextController createText(ControllerCore genCode) {
		...
		textTXT = new TextController("text", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getText();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("text");
	...
	public TextController createToolTipText(ControllerCore genCode) {
		...
		toolTipTextTXT = new TextController("toolTipText", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getToolTipText();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public XjcTextController createVisible(ControllerCore genCode) {
		...
		visibleTXT = new XjcTextController("visible", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getVisible();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
				setProperty("visible");
	...
	public TextController createWhitespaceNormalized(ControllerCore genCode) {
		// Creates control for TextController whitespaceNormalizedTXT
		whitespaceNormalizedTXT = new TextController("whitespaceNormalized", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(whitespaceNormalized$1LBL);
				setProperty("whitespaceNormalized");
				super.initialize();
			}
			@Override
			public void createControl() {
		...
		return whitespaceNormalizedTXT;
	}
	public CodeTextController createConvertModelToTarget(ControllerCore genCode) {
		...
		convertModelToTargetTXT = new CodeTextController("convertModelToTarget", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getConvertModelToTarget();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public CodeTextController createConvertTargetToModel(ControllerCore genCode) {
		...
		convertTargetToModelTXT = new CodeTextController("convertTargetToModel", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getConvertTargetToModel();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
	...
	public CodeTextController createInitialValue(ControllerCore genCode) {
		...
		initialValueTXT = new CodeTextController("initialValue", getParentController(basicItemSCSCLC), genCode) {
			...
			public void initialize() {
				...
				evaluatorVALID = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((EditableFormTextType) getEntity().getBean()).getInitialValue();
					}
				};
				addAccessibility(new ElementaryAccessibility(ElementaryAccessibility.ACCESS_ATTRIBUTE.VALID, evaluatorVALID));
