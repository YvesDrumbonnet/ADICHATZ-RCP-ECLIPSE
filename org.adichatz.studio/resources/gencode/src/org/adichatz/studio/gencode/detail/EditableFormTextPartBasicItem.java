/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:17:21 CET 2019
 *
 * 				+----------------------------------------+
...
public class EditableFormTextPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController fieldBindManagerClassNameEditableFormTextPART$1HL.
	private HyperlinkController fieldBindManagerClassNameEditableFormTextPART$1HL;
	...
	// the HyperlinkController controllerClassNameEditableFormTextPART$1HL.
	private HyperlinkController controllerClassNameEditableFormTextPART$1HL;
	...
	public HyperlinkController createFieldBindManagerClassNameEditableFormTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameEditableFormTextPART$1HL
		fieldBindManagerClassNameEditableFormTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameEditableFormTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameEditableFormTextPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameEditableFormTextPART$1HL
		controllerClassNameEditableFormTextPART$1HL = new HyperlinkController("controllerClassNameEditableFormTextPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
