...
public class LazyFetchContainerPart extends AContainerCore {
	...
	// the HyperlinkController controllerClassNameLazyFetchContainerPART$1HL.
	private HyperlinkController controllerClassNameLazyFetchContainerPART$1HL;
	...
	*/
	...
	public HyperlinkController createControllerClassNameLazyFetchContainerPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameLazyFetchContainerPART$1HL
		controllerClassNameLazyFetchContainerPART$1HL = new HyperlinkController("controllerClassNameLazyFetchContainerPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
