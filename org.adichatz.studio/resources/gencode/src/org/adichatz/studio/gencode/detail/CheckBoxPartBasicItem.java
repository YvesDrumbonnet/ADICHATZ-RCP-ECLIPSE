...
public class CheckBoxPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameCheckBoxPART$1HL.
	private HyperlinkController controllerClassNameCheckBoxPART$1HL;
	...
	// the HyperlinkController fieldBindManagerClassNameCheckBoxPART$1HL.
	private HyperlinkController fieldBindManagerClassNameCheckBoxPART$1HL;
	...
	public HyperlinkController createControllerClassNameCheckBoxPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameCheckBoxPART$1HL
		controllerClassNameCheckBoxPART$1HL = new HyperlinkController("controllerClassNameCheckBoxPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameCheckBoxPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController fieldBindManagerClassNameCheckBoxPART$1HL
		fieldBindManagerClassNameCheckBoxPART$1HL = new HyperlinkController("fieldBindManagerClassNameCheckBoxPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
