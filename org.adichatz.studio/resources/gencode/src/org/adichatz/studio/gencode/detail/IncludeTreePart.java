...
public class IncludeTreePart extends AContainerCore {
	...
	// the OutlineHyperlinkController entityURIIncludeTreePART$1HL.
	private OutlineHyperlinkController entityURIIncludeTreePART$1HL;
	...
	*/
	...
	public OutlineHyperlinkController createEntityURIIncludeTreePART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController entityURIIncludeTreePART$1HL
		entityURIIncludeTreePART$1HL = new OutlineHyperlinkController("entityURIIncludeTreePART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				BooleanSupplier evaluatorENABLED;
				evaluatorENABLED = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((IncludeTree) parentController.getEntity().getBean()).getEntityURI();
					}
				};
