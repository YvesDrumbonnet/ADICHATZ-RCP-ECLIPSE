...
public class StarRatingPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates StarRatingPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public StarRatingPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		maxNumberOfStars$1LBL = new LabelController("maxNumberOfStars$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		numericPattern$1LBL = new LabelController("numericPattern$1", controlItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public TextController createMaxNumberOfStars(ControllerCore genCode) {
		...
		maxNumberOfStarsTXT = new TextController("maxNumberOfStars", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createNumericPattern(ControllerCore genCode) {
		...
		numericPatternTXT = new TextController("numericPattern", getParentController(controlItemSCSCLC), genCode) {
			@Override
			public void initialize() {
