...
public class NumericTextPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameNumericTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameNumericTextPART$1HL = new HyperlinkController("controllerClassNameNumericTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameNumericTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameNumericTextPART$1HL = new HyperlinkController("fieldBindManagerClassNameNumericTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
