...
public class NumericTextPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates NumericTextPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public NumericTextPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameNumericTextPART$1(ControllerCore genCode) {
		...
		controllerClassNameNumericTextPART$1HL = new OutlineHyperlinkController("controllerClassNameNumericTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createFieldBindManagerClassNameNumericTextPART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameNumericTextPART$1HL = new OutlineHyperlinkController("fieldBindManagerClassNameNumericTextPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
