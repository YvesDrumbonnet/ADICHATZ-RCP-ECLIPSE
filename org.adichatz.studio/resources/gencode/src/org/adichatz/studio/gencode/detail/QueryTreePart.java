/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:35:08 CEST 2020
 *
 * 				+----------------------------------------+
	...
	public void createContents(){
		...
		itemCompositeSCLC = new ScrolledCompositeController("itemComposite", coreController, this) {
			...
			public void initialize() {
				AControlListener itemCompositeLSTN$0 = new AControlListener("AFTER_SYNCHRONIZE", IEventType.AFTER_SYNCHRONIZE) {
					@Override
			...
			public void synchronize() {
				super.synchronize();
				if (isValid()) {
					AEntityListener itemCompositeLSTN$1 = new AEntityListener("AFTER_PROPERTY_CHANGE", itemCompositeSCLC, IEventType.AFTER_PROPERTY_CHANGE) {
						@Override
						public void handleEntityEvent(AdiEntityEvent event) {
							displaySQLorWhereClause();
						}
					};
					AEntityListener itemCompositeLSTN$2 = new AEntityListener("POST_REFRESH", itemCompositeSCLC, IEventType.POST_REFRESH) {
						@Override
						public void handleEntityEvent(AdiEntityEvent event) {
							displaySQLorWhereClause();
						}
