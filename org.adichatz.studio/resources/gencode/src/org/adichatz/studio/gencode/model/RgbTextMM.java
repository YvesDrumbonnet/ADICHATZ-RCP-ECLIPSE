/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:32:38 CEST 2020
 *
 * 				+----------------------------------------+
...
@AdiResourceURI(URI="adi://org.adichatz.studio/model/RgbTextMM")
public class RgbTextMM extends AXjcEntityMetaModel<RgbTextType> {
	/**
	 * Creates the MetaModel class for RgbTextMM.
	 *
	 */
	public RgbTextMM(PluginEntity<?> pluginEntity) {
		super(pluginEntity);
	...
	/**
	 * Create contents for MetaModel RgbTextMM.
	 */
	public void create(){
		addSuperFields();
	}
	 ...
	 */
	@Override
	public Class<RgbTextType> getBeanClass() {
		return RgbTextType.class;
	}
	@Override
