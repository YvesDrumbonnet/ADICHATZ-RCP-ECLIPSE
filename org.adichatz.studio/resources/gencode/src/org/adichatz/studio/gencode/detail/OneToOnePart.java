/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:53:25 CEST 2020
 *
 * 				+----------------------------------------+
...
public class OneToOnePart extends AContainerCore {
	...
	// the OutlineHyperlinkController entityURIOneToOnePART$1HL.
	private OutlineHyperlinkController entityURIOneToOnePART$1HL;
	...
	*/
	...
	public OutlineHyperlinkController createEntityURIOneToOnePART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController entityURIOneToOnePART$1HL
		entityURIOneToOnePART$1HL = new OutlineHyperlinkController("entityURIOneToOnePART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				BooleanSupplier evaluatorENABLED;
				evaluatorENABLED = new BooleanSupplier() {
					public boolean getAsBoolean() {
						return null != ((OneToOneType) parentController.getEntity().getBean()).getEntityURI();
					}
				};
