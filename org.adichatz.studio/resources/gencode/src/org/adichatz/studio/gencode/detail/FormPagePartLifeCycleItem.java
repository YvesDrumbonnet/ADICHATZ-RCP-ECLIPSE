...
public class FormPagePartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createBindingServiceClassNameFormPagePART$1(ControllerCore genCode) {
		...
		bindingServiceClassNameFormPagePART$1HL = new HyperlinkController("bindingServiceClassNameFormPagePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createControllerClassNameFormPagePART$1(ControllerCore genCode) {
		...
		controllerClassNameFormPagePART$1HL = new HyperlinkController("controllerClassNameFormPagePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIFormPagePART$1(ControllerCore genCode) {
		...
		entityURIFormPagePART$1HL = new HyperlinkController("entityURIFormPagePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
