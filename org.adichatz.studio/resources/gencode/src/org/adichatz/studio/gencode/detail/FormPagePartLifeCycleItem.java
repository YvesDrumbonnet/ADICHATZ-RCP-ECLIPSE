/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:52:47 CEST 2020
 *
 * 				+----------------------------------------+
...
public class FormPagePartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates FormPagePartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public FormPagePartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		formMessageManager$1LBL = new LabelController("formMessageManager$1", lifeCycleItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		validStatus$1LBL = new LabelController("validStatus$1", lifeCycleItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createBindingServiceClassNameFormPagePART$1(ControllerCore genCode) {
		...
		bindingServiceClassNameFormPagePART$1HL = new OutlineHyperlinkController("bindingServiceClassNameFormPagePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public ClassTextController createBindingServiceClassName(ControllerCore genCode) {
		...
		bindingServiceClassNameTXT = new ClassTextController("bindingServiceClassName", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
	...
	public OutlineHyperlinkController createControllerClassNameFormPagePART$1(ControllerCore genCode) {
		...
		controllerClassNameFormPagePART$1HL = new OutlineHyperlinkController("controllerClassNameFormPagePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIFormPagePART$1(ControllerCore genCode) {
		...
		entityURIFormPagePART$1HL = new OutlineHyperlinkController("entityURIFormPagePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public BooleanRadioGroupController createFormMessageManager(ControllerCore genCode) {
		...
		formMessageManagerRG = new BooleanRadioGroupController("formMessageManager", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createValidStatus(ControllerCore genCode) {
		...
		validStatusTXT = new TextController("validStatus", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
