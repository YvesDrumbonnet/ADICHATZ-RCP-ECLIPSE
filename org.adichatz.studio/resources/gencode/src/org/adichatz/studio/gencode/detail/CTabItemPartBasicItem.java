/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:16:48 CET 2019
 *
 * 				+----------------------------------------+
...
public class CTabItemPartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameCTabItemPART$1HL.
	private HyperlinkController controllerClassNameCTabItemPART$1HL;
	...
	// the HyperlinkController entityURICTabItemPART$1HL.
	private HyperlinkController entityURICTabItemPART$1HL;
	...
	public HyperlinkController createControllerClassNameCTabItemPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameCTabItemPART$1HL
		controllerClassNameCTabItemPART$1HL = new HyperlinkController("controllerClassNameCTabItemPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURICTabItemPART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURICTabItemPART$1HL
		entityURICTabItemPART$1HL = new HyperlinkController("entityURICTabItemPART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
