/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:54:07 CEST 2020
 *
 * 				+----------------------------------------+
...
public class TablePartLifeCycleItem extends EntityManagerCore {
	...
	public OutlineHyperlinkController createControllerClassNameTablePART$1(ControllerCore genCode) {
		...
		controllerClassNameTablePART$1HL = new OutlineHyperlinkController("controllerClassNameTablePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURITablePART$1(ControllerCore genCode) {
		...
		entityURITablePART$1HL = new OutlineHyperlinkController("entityURITablePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
