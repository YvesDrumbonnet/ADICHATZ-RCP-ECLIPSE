	...
	public XjcTreeEditorTreeForm(final AdiContext context, IContainerController parentController) {
			...
			public void createControl() {
				if (isValid()) {
					action = new ExpandTreeAction() {
						...
						public void init() {
							super.init();
							setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_DEVELOP"));
							setToolTipText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "adichatzStudio", "studio.editor.expandTree"));
						}
					};
				...
				super.createControl();
				if (isValid()) {
					getControl().setImageDescriptor(AdichatzApplication.getInstance().getFormToolkit().getRegisteredImageDescriptor("IMG_DEVELOP"));
					getControl().setToolTipText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "adichatzStudio", "studio.editor.expandTree"));
				}
			}
		};
			...
			public void createControl() {
				if (isValid()) {
					action = new CollapseTreeAction() {
						...
						public void init() {
							super.init();
							setImageDescriptor(AdichatzApplication.getInstance().getImageDescriptor("org.adichatz.studio", "IMG_COLLAPSE.gif"));
							setToolTipText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "adichatzStudio", "studio.editor.collapseTree"));
						}
					};
					action.setActionController(this);
				}
				super.createControl();
				if (isValid()) {
					getControl().setImageDescriptor(AdichatzApplication.getInstance().getImageDescriptor("org.adichatz.studio", "IMG_COLLAPSE.gif"));
					getControl().setToolTipText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "adichatzStudio", "studio.editor.collapseTree"));
				}
			}
		};
		...
		switchToActiveFileActionACT = new SwitchToActiveFileActionController("switchToActiveFileAction", mtoolBarCtler, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setImageDescriptor(AdichatzApplication.getInstance().getImageDescriptor("org.adichatz.studio", "IMG_SWITCH.png"));
					getControl().setToolTipText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "adichatzStudio", "studio.xjcEditor.switchToActiveFile"));
				}
			}
		};
		...
		compareFilesActionACT = new CompareFilesActionController("compareFilesAction", mtoolBarCtler, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setImageDescriptor(AdichatzApplication.getInstance().getImageDescriptor("org.adichatz.studio", "IMG_COMPARE.png"));
					getControl().setToolTipText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "adichatzStudio", "studio.xjcEditor.compareCustomizedAndGeneratedFiles"));
				}
			}
		};
		...
		openJavaFileMenuActionMACT = new OpenJavaFileMAController("openJavaFileMenuAction", mtoolBarCtler, this) {
			...
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setImageDescriptor(AdichatzApplication.getInstance().getImageDescriptor("org.adichatz.studio", "IMG_GENERATE_JAVA_FILES.png"));
				}
			}
		};
