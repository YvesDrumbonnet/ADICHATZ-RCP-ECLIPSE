...
public class MultiChoicePartBasicItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameMultiChoicePART$1(ControllerCore genCode) {
		...
		controllerClassNameMultiChoicePART$1HL = new HyperlinkController("controllerClassNameMultiChoicePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createFieldBindManagerClassNameMultiChoicePART$1(ControllerCore genCode) {
		...
		fieldBindManagerClassNameMultiChoicePART$1HL = new HyperlinkController("fieldBindManagerClassNameMultiChoicePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createLabelProviderClassNameMultiChoicePART$1(ControllerCore genCode) {
		...
		labelProviderClassNameMultiChoicePART$1HL = new HyperlinkController("labelProviderClassNameMultiChoicePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
