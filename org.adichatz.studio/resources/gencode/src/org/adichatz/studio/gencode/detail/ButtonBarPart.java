/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:51:53 CEST 2020
 *
 * 				+----------------------------------------+
...
@AdiResourceURI(URI="adi://org.adichatz.studio/detail/ButtonBarPart")
public class ButtonBarPart extends AContainerCore {
	...
	// the OutlineHyperlinkController controllerClassNameButtonBarPART$1HL.
	private OutlineHyperlinkController controllerClassNameButtonBarPART$1HL;
	...
	// the LabelController separator$1LBL.
	private LabelController separator$1LBL;
	// the BooleanRadioGroupController separatorRG.
	private BooleanRadioGroupController separatorRG;
	...
	/**
	 * Instantiates a new ButtonBarPart.
	 * 
	 ...
	 */
	public ButtonBarPart(AdiContext parentContext, IContainerController parentController) {
		super(null, parentController, null);
		coreController = parentController;
	}

	/**
	 * Creates the part ButtonBarPart.
	 *
	 ...
	 *            the param map
	*/
	public ButtonBarPart(AdiPluginResources pluginResources, IContainerController coreController, ParamMap paramMap) {
	...
	public void createContents(){
		...
		createControllerClassNameButtonBarPART$1(this);
		...
		createRef(this);
		// Creates control for LabelController separator$1LBL
		separator$1LBL = new LabelController("separator$1", itemCompositeSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
					getControl().setText(AdichatzApplication.getInstance().getMessage("org.adichatz.studio", "buttonBar", "separator").concat(":"));
					setForeground(AdichatzApplication.getInstance().getFormToolkit().getColors().getColor(IFormColors.TITLE));
				}
			}
		};
	...
	public OutlineHyperlinkController createControllerClassNameButtonBarPART$1(ControllerCore genCode) {
		// Creates control for OutlineHyperlinkController controllerClassNameButtonBarPART$1HL
		controllerClassNameButtonBarPART$1HL = new OutlineHyperlinkController("controllerClassNameButtonBarPART$1", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
		...
		return controllerClassNameButtonBarPART$1HL;
	}
	public ClassTextController createControllerClassName(ControllerCore genCode) {
		...
		controllerClassNameTXT = new ClassTextController("controllerClassName", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(controllerClassNameButtonBarPART$1HL);
	...
	public BooleanRadioGroupController createSeparator(ControllerCore genCode) {
		// Creates control for BooleanRadioGroupController separatorRG
		separatorRG = new BooleanRadioGroupController("separator", getParentController(itemCompositeSCLC), genCode) {
			@Override
			public void initialize() {
				setLinkedController(separator$1LBL);
