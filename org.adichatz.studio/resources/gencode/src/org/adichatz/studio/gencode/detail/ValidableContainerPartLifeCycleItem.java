/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:19:11 CET 2019
 *
 * 				+----------------------------------------+
...
public class ValidableContainerPartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameValidableContainerPART$1(ControllerCore genCode) {
		...
		controllerClassNameValidableContainerPART$1HL = new HyperlinkController("controllerClassNameValidableContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURIValidableContainerPART$1(ControllerCore genCode) {
		...
		entityURIValidableContainerPART$1HL = new HyperlinkController("entityURIValidableContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
