/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Mon Jul 06 18:35:47 CEST 2020
 *
 * 				+----------------------------------------+
...
public class ValidableContainerPartLifeCycleItem extends EntityManagerCore {
	...
	/**
	 * Creates ValidableContainerPartLifeCycleItem.
	 *
	 * @param context
	 ...
	 */
	public ValidableContainerPartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public OutlineHyperlinkController createControllerClassNameValidableContainerPART$1(ControllerCore genCode) {
		...
		controllerClassNameValidableContainerPART$1HL = new OutlineHyperlinkController("controllerClassNameValidableContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURIValidableContainerPART$1(ControllerCore genCode) {
		...
		entityURIValidableContainerPART$1HL = new OutlineHyperlinkController("entityURIValidableContainerPART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
