...
public class TreePartLifeCycleItem extends EntityManagerCore {
	...
	public HyperlinkController createControllerClassNameTreePART$1(ControllerCore genCode) {
		...
		controllerClassNameTreePART$1HL = new HyperlinkController("controllerClassNameTreePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURITreePART$1(ControllerCore genCode) {
		...
		entityURITreePART$1HL = new HyperlinkController("entityURITreePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
