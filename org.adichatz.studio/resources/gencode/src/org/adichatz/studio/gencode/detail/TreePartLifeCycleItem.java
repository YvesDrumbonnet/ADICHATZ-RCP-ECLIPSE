/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Tue Apr 28 15:54:16 CEST 2020
 *
 * 				+----------------------------------------+
...
public class TreePartLifeCycleItem extends EntityManagerCore {
	 ...
	 */
	public TreePartLifeCycleItem(final AdiContext context, IContainerController parentController) {
		super(context);
	...
	public void createContents(){
		...
		treeManager$1LBL = new LabelController("treeManager$1", lifeCycleItemSCSCLC, this) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createControllerClassNameTreePART$1(ControllerCore genCode) {
		...
		controllerClassNameTreePART$1HL = new OutlineHyperlinkController("controllerClassNameTreePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public OutlineHyperlinkController createEntityURITreePART$1(ControllerCore genCode) {
		...
		entityURITreePART$1HL = new OutlineHyperlinkController("entityURITreePART$1", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
	...
	public TextController createTreeManager(ControllerCore genCode) {
		...
		treeManagerTXT = new TextController("treeManager", getParentController(lifeCycleItemSCSCLC), genCode) {
			@Override
			public void initialize() {
