...
public class RgbTextPartControlItem extends EntityManagerCore {
	...
	/**
	 * Creates RgbTextPartControlItem.
	 *
	 * @param context
	 ...
	 */
	public RgbTextPartControlItem(final AdiContext context, IContainerController parentController) {
		super(context);
