/**********************************************************************************************
 * This class was automatically generated by Adichatz tools on Sat Dec 07 15:19:08 CET 2019
 *
 * 				+----------------------------------------+
...
public class TreePartBasicItem extends EntityManagerCore {
	...
	// the HyperlinkController controllerClassNameTreePART$1HL.
	private HyperlinkController controllerClassNameTreePART$1HL;
	...
	// the HyperlinkController entityURITreePART$1HL.
	private HyperlinkController entityURITreePART$1HL;
	...
	public HyperlinkController createControllerClassNameTreePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController controllerClassNameTreePART$1HL
		controllerClassNameTreePART$1HL = new HyperlinkController("controllerClassNameTreePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
	...
	public HyperlinkController createEntityURITreePART$1(ControllerCore genCode) {
		// Creates control for HyperlinkController entityURITreePART$1HL
		entityURITreePART$1HL = new HyperlinkController("entityURITreePART$1", getParentController(basicItemSCSCLC), genCode) {
			@Override
			public void createControl() {
				super.createControl();
				if (isValid()) {
